...
public class GestionDeClientes_Fw extends BasePageFw {
	...
	public GestionDeClientes_Fw(WebDriver driver) {
		...
		super.getFluentWait().withTimeout(50, TimeUnit.SECONDS).pollingEvery(500, TimeUnit.MILLISECONDS)
...
//		}
	...
	public void switchToFrameBySrc(String src) {// el Ruben ZAPE!!
		...
		// WebElement frame =
		// driver.findElement(By.cssSelector("iframe[src*='"+src+"']"));
...
//			elementos.addAll(driver.findElements(By.cssSelector("[class='slds-button slds-button--neutral ']")));
	...
	public void altaBajaServicio(String altaBaja, String servicio) {
		...
		List<WebElement> segundosBotones = driver.findElements(By.cssSelector(
				"[class='cpq-item-base-product'] [class='cpq-item-product-child-level-2 cpq-item-child-product-name-wrapper'] button"));
		...
		case "alta":
			try {
				servicioEncontrado.findElement(By.cssSelector("[class='cpq-item-base-product-actions slds-text-align_right'] [class='slds-button slds-button_neutral secondary']")).click();
			} catch (Exception e) {
