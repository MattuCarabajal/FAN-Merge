...
public class VentaDePackFw extends BasePageFw {
	...
	public VentaDePackFw(WebDriver driver) {
		...
		super.getFluentWait().withTimeout(30, TimeUnit.SECONDS).pollingEvery(500, TimeUnit.MILLISECONDS)
	...
	// TODOS LOS PACKS == Packs Combinados, Packs de Datos, Packs LDI, Packs de
	// Roaming, Packs de SMS, Packs de Minutos, Packs OTT.
