	...
	public void TS125406_CRM_Interfaz_LCRM_CustomerANI() throws ParseException, IOException {
		...
		for (List<List<String>> sList : sFilesContent) {
			for (List<String> lsAux : sList) {
				...
				Assert.assertTrue(rsePage.verifyTextMaxSize(sRazonSocial, 0));// preguntar no tiene cantidad de
																				// caracteres
				...
				Assert.assertTrue(rsePage.verifyTextMaxSize(sTipoDePlan, 0));// preguntar no tiene cantidad de
																				// caracteres

				String sCompaniaPortIN = lsAux.get(18);
				Assert.assertTrue(rsePage.verifyTextMaxSize(sCompaniaPortIN, 0));// preguntar no tiene cantidad de
																					// caracteres

				String sIDContacto = lsAux.get(19);
				Assert.assertTrue(rsePage.verifyTextMaxSize(sIDContacto, 0));// preguntar no tiene cantidad de
																				// caracteres
	...
	public void TS125408_CRM_Interfaz_LCRM_CuentaFacturacionInsercion() throws ParseException, IOException {
		...
		for (List<List<String>> sList : sFilesContent) {
			for (List<String> lsAux : sList) {
				...
				Assert.assertTrue(rsePage.verifyTextMaxSize(sDireccionlinea, 0));// preguntar mensaje "Pendiente
																					// Vlovity"

				String sProvincia_Linea = lsAux.get(4);
				Assert.assertTrue(rsePage.verifyTextMaxSize(sProvincia_Linea, 0));// preguntar mensaje "Pendiente
																					// Vlovity"
	...
	public void TS125412_CRM_Interfaz_LCRM_ProductoAdquiridoLinea() throws ParseException, IOException {
		...
		for (List<List<String>> sList : sFilesContent) {
			for (List<String> lsAux : sList) {
				...
				Assert.assertTrue(rsePage.verifyTextMaxSize(sNombreVendedor, 0));// preguntar no tiene cantidad de
																					// caracteres

				String sCodigoPuntoVenta = lsAux.get(24);
				Assert.assertTrue(rsePage.verifyTextMaxSize(sCodigoPuntoVenta, 0));// preguntar no tiene cantidad de
																					// caracteres

				String sNombrePuntoVenta = lsAux.get(25);
				Assert.assertTrue(rsePage.verifyTextMaxSize(sNombrePuntoVenta, 0));// preguntar no tiene cantidad de
																					// caracteres

				String sEstadoLineaSusp = lsAux.get(26);
				Assert.assertTrue(rsePage.verifyTextMaxSize(sEstadoLineaSusp, 0));// preguntar no tiene cantidad de
																					// caracteres

				String sProcedencia_portabilidad = lsAux.get(27);
				Assert.assertTrue(rsePage.verifyTextMaxSize(sProcedencia_portabilidad, 0));// preguntar no tiene
	...
	public void TS125413_CRM_Interfaz_LCRM_ProductoAdquiridoEquipos() throws ParseException, IOException {
		...
		for (List<List<String>> sList : sFilesContent) {
			for (List<String> lsAux : sList) {
				...
				Assert.assertTrue(rsePage.verifyTextMaxSize(sPTVTADescripcionSeparadosPorUnEspacio, 0));// preguntar no
																										// tiene
																										// cantidad de
																										// caracteres
				...
				Assert.assertTrue(rsePage.verifyTextMaxSize(sCOD_TIPIFICACION, 0));// preguntar no tiene cantidad de
																					// caracteres
				...
				Assert.assertTrue(rsePage.verifyTextMaxSize(sDESCR_CANAL, 0));// preguntar no tiene cantidad de
																				// caracteres
				...
				Assert.assertTrue(rsePage.verifyTextMaxSize(sSIN_IMPUESTO, 0));// preguntar no tiene cantidad de
																				// caracteres

				String sId_Procedencia = lsAux.get(38);
				Assert.assertTrue(rsePage.verifyTextMaxSize(sId_Procedencia, 0));// preguntar no tiene cantidad de
																					// caracteres
	...
	public void TS125418_CRM_Interfaz_LCRM_Caso() throws ParseException, IOException {
		...
		for (List<List<String>> sList : sFilesContent) {
			for (List<String> lsAux : sList) {
				...
				if (!sDireccionEmail.isEmpty())
					sDireccionEmail.contains("@");
				Assert.assertTrue(rsePage.verifyTextMaxSize(sDireccionEmail, 80));
