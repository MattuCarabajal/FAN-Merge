...
public class ConsultaDeSaldo extends TestBase {
	...
	@Test (groups = {"PerfilOficina" , "R1", "ConsultaDeSaldo", "Ciclo1"}, dataProvider = "ConsultaSaldo")
	...
	@Test (groups = {"PerfilTelefonico" , "R1", "ConsultaDeSaldo", "Ciclo1"}, dataProvider = "ConsultaSaldo")
