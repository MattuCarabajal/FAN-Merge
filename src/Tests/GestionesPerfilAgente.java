...
public class GestionesPerfilAgente extends TestBase {
	...
	public void TS134322_CRM_Movil_REPRO_Recargas_Presencial_TC_Agente(String sDNI, String sMonto, String sLinea,
	...
	// ESTE 1
	@Test(groups = { "GestionesPerfilAgente", "CambioSimCard", "E2E",
			"Ciclo3" }, priority = 1, dataProvider = "CambioSimCardAgente")
	...
	public void Venta_de_Pack_1_GB_x_1_dia_whatsapp_gratis_Factura_de_Venta_efectivo_Agente(String sDNI, String sLinea,
			String sPackAgente) throws AWTException {
		...
		detalles += "-Monto:" + invoice.split("-")[1] + "-Prefactura:" + invoice.split("-")[0];
		sleep(10000);
		System.out.println("Operacion: Compra de Pack- Cuenta: " + accid + " Invoice: " + invoice.split("-")[1]
				+ "\tAmmount: " + invoice.split("-")[0]);
		CBS_Mattu cCBSM = new CBS_Mattu();
		Assert.assertTrue(
				cCBSM.PagoEnCaja("1005", accid, "1001", invoice.split("-")[0], invoice.split("-")[1], driver));
		sleep(5000);
		driver.navigate().refresh();
		sleep(10000);
		CBS cCBS = new CBS();
	...
	@Test(groups = { "GestionesPerfilAgente", "AnulacionDeVenta", "E2E",
	...
	public void TS134814_CRM_Movil_Prepago_Vista_360_Consulta_de_Saldo_Verificar_credito_prepago_de_la_linea_FAN_Front_Agentes(
	...
	public void TS134827_CRM_Movil_Prepago_Vista_360_Detalle_de_consumo_Consulta_detalle_de_consumo_Datos_FAN_Front_Agentes(
	...
	@Test(groups = { "GestionesPerfilAgente", "DetalleDeConsumo", "Ciclo2" }, dataProvider = "CuentaProblemaRecarga")
	public void TS134826_CRM_Movil_Prepago_Vista_360_Detalle_de_consumo_Consulta_detalle_de_consumo_SMS_FAN_Front_Agentes(
	...
	@Test(groups = { "GestionesPerfilAgente", "DetalleDeConsumo",
			"Ciclo2" }, dataProvider = "CuentaModificacionDeDatos")
	public void TS134828_CRM_Movil_Prepago_Vista_360_Detalle_de_consumo_Consulta_detalle_de_consumo_Voz_FAN_Front_Agentes(
			String sDNI, String sLinea) {
		imagen = "TS134828";
		detalles = null;
	...
	@Test(groups = { "GestionesPerfilAgente", "DetalleDeConsumo",
			"Ciclo2" }, dataProvider = "CuentaModificacionDeDatos")
	public void TS134829_CRM_Movil_Prepago_Vista_360_Detalle_de_consumo_Consulta_detalle_de_Otros_consumos_FAN_Front_Agentes(
			String sDNI, String sLinea) {
		imagen = "TS134829";
		detalles = null;//////////////
		detalles = imagen + "Detalle de Consumos -DNI:" + sDNI;
	...
	@Test(groups = { "GestionesPerfilAgente", "ConsultaDeSaldo", "Ciclo1" }, dataProvider = "ConsultaSaldo")
	public void TS134815_CRM_Movil_Prepago_Vista_360_Consulta_de_Saldo_Verificar_saldo_del_cliente_FAN_Front_Agentes(
			String sDNI, String sLinea, String sAccountKey) {
		imagen = "TS134815";
		detalles = null;
		detalles = imagen + "Consulta de saldo -DNI:" + sDNI;
	...
	@Test(groups = { "GestionesPerfilAgente", "Sales", "PreparacionNominacion", "E2E",
			"Ciclo1" }, dataProvider = "DatosSalesNominacionNuevoAgente")
	public void TS_CRM_Nominacion_Argentino_Agente(String sLinea, String sDni, String sNombre, String sApellido,
			String sSexo, String sFnac, String sEmail, String sProvincia, String sLocalidad, String sCalle,
			String sNumCa, String sCP) {
		...
		for (WebElement UnaL : Lineas) {
			if (UnaL.getText().toLowerCase().contains("plan con tarjeta")
	...
	public void TS134818_CRM_Movil_Prepago_Vista_360_Mis_Servicios_Visualizacion_del_estado_de_los_Productos_activos_FAN_Front_Agentes(
	...
	@Test(groups = { "GestionesPerfilAgente", "RenovacionDeCuota", "E2E",
			"Ciclo1" }, dataProvider = "RenovacionCuotaConSaldo")
	public void TS135402_CRM_Movil_REPRO_Renovacion_de_cuota_Presencial_Internet_50_MB_Dia_Descuento_de_saldo_con_Credito(
			String sDNI, String sLinea) {
		imagen = "TS135402";
	...
	public void TS134821_CRM_Movil_Prepago_Vista_360_Distribucion_de_paneles_Visualizacion_e_ingreso_a_las_ultimas_gestiones_FAN_Front_Agentes(
			String sDNI, String sNombre, String sLinea) {
		imagen = "TS134821";
		detalles = null;
		detalles = imagen + "Vista 360 -DNI:" + sDNI;
		...
		((JavascriptExecutor) driver).executeScript("window.scrollTo(0," + driver
				.findElement(
						By.cssSelector(".slds-grid.slds-wrap.slds-card.slds-m-bottom--small.slds-m-around--medium"))
				.getLocation().y + " )");
		WebElement nroCaso = driver
				.findElement(
						By.cssSelector(".slds-grid.slds-wrap.slds-card.slds-m-bottom--small.slds-m-around--medium"))
		...
		if (nroCaso.findElements(By.tagName("td")).get(2).findElement(By.tagName("div")).findElement(By.tagName("a"))
				.isDisplayed()) {
	...
	@Test(groups = { "GestionesPerfilAgente", "ModificarDatos", "E2E",
			"Ciclo3" }, dataProvider = "CuentaModificacionDeDatos")
	public void TS134836_CRM_Movil_REPRO_Modificacion_de_datos_Actualizar_los_datos_del_cliente_completos_FAN_Front_Agentes(
			String sDNI, String sLinea) {
		imagen = "TS134836";
		detalles = null;
	...
	@Test(groups = { "GestionesPerfilAgente", "ModificarDatos", "E2E",
			"Ciclo3" }, dataProvider = "CuentaModificacionDeDatos")
	public void TS129334_CRM_Movil_REPRO_Modificacion_de_datos_Actualizar_datos_campo_Correo_Electronico_Cliente_FAN_Front_Agentes(
			String sDNI, String sLinea) {
		imagen = "TS129334";
		detalles = null;
		detalles = imagen + " -ActualizarDatos: " + sDNI;
	...
	@Test(groups = { "GestionesPerfilAgente", "ModificarDatos", "E2E",
			"Ciclo3" }, dataProvider = "CuentaModificacionDeDatos")
	public void TS121103_CRM_Movil_REPRO_Modificacion_de_datos_No_Actualizar_datos_Cliente_FAN_Front_Agentes(
			String sDNI, String sLinea) {
		imagen = "TS121103";
		detalles = null;
	...
	@Test(groups = { "GestionesPerfilAgente", "ModificarDatos", "E2E",
			"Ciclo3" }, dependsOnMethods = "TS121103_CRM_Movil_REPRO_Modificacion_de_datos_No_Actualizar_datos_Cliente_FAN_Front_Agentes")
	...
	@Test(groups = { "GestionesPerfilAgente", "Vista360", "E2E", "ConsultaPorGestion",
			"Ciclo2" }, dataProvider = "CuentaVista360")
	public void TS134831_CRM_Movil_Prepago_Vista_360_Consulta_por_gestiones_Gestiones_Cerrada_Informacion_brindada_FAN_Front_Agentes(
			String sDNI, String sNombre, String sLinea) {
		imagen = "TS134831";
		detalles = null;
		detalles = imagen + "-Vista 360 -DNI:" + sDNI;
		...
		for (WebElement x : lista) {
			if (x.getText().toLowerCase().contains("resuelta exitosa")
					|| x.getText().toLowerCase().contains("realizada exitosa")) {
				System.out.println(x.getText());
				verificacion = true;
			}
		}
	...
	public void TS135737_CRM_Movil_REPRO_Baja_de_Servicio_sin_costo_Restriccion_Ident_de_Llamadas_Presencial_Agente(
			String sDNI, String sLinea) throws AWTException {
		imagen = "TS135737";
		detalles = imagen + "-BajaServicio-DNI:" + sDNI;
		GestionFlow gGF = new GestionFlow();
		// Assert.assertTrue(gGF.FlowConsultaServicioActivo(driver, sLinea,
		// "Restricci\u00f3n de la Identificaci\u00f3n de Llamadas"));
		BasePage cambioFrameByID = new BasePage();
		sleep(30000);
		driver.switchTo().frame(cambioFrameByID.getFrameForElement(driver, By.id("SearchClientDocumentType")));
		sleep(1000);
	...
	public void TS135754_CRM_Movil_REPRO_Alta_Servicio_sin_costo_Transferencia_de_llamadas_Presencial_Agente(
			String sDNI, String sLinea) throws AWTException {
		imagen = "TS135754";
		detalles = null;
	...
	public void TS135380_CRM_Movil_Prepago_Otros_Historiales_Historial_de_ajustes_Ordenamiento_por_Motivo_de_ajuste_FAN_Front_Agente(
			String sDNI, String sLinea) {
		imagen = "TS135380";
	...
	public void TS121364_CRM_Movil_REPRO_Servicio_Tecnico_Realiza_reparaciones_de_equipos_Validacion_de_IMEI_Ok_Con_Garantia_Derivado_a_Servicio_Tecnico_Sin_Muleto_Terminal_reparada_y_entregada_Agente(
			String sDNI, String sLinea, String sIMEI) throws InterruptedException {
		imagen = "TS121364";
		detalles = null;
	...
	@Test(groups = { "GestionesPerfilAgente", "Ciclo 3", "E2E",
			"CambioDeSimCard" }, priority = 1, dataProvider = "SimCardSiniestroAG")
	public void TS99020_CRM_Movil_REPRO_Cambio_de_SimCard_Presencial_Siniestro_DOC_Store_Pick_Up_TC_Agente(String sDNI,
			String sLinea, String sEntrega, String sProvincia, String sLocalidad, String sPuntodeVenta)
			throws AWTException {
		imagen = "99020";
		detalles = null;
	...
	@Test(groups = { "GestionesPerfilAgente", "ServicioTecnico", "E2E", "Ciclo4" }, dataProvider = "serviciotecnico")
	public void TS121367_CRM_Movil_REPRO_Servicio_Tecnico_Realiza_configuraciones_de_equipos_Validacion_de_IMEI_Ok_Configuracion_Con_Garantia_Sin_Muleto_Reparar_ahora_Agente(
			String sDNI, String sLinea, String sIMEI, String sEmail, String sOpcion, String sSintoma)
	...
	@Test(groups = { "GestionesPerfilAgente", "DiagnosticoIncoveniente", "E2E",
			"Ciclo3" }, dataProvider = "Diagnostico")
	public void TS119283_CRM_Movil_REPRO_Diagnostico_de_Datos_Valida_Red_y_Navegacion_Motivo_de_contacto_No_puedo_navegar_Antena_rojo_NO_BAM_Agente(
	...
	@Test(groups = { "GestionesPerfilAgente", "NumerosAmigos", "E2E",
			"Ciclo1" }, dataProvider = "NumerosAmigosModificacion")
	public void TS139724_CRM_Movil_REPRO_FF_Modificacion_Agente(String sDNI, String sLinea, String sNumeroVOZ,
			String sNumeroSMS) {
		imagen = "TS139724";
		BasePage cambioFrame = new BasePage();
		CBS sCBS = new CBS();
		CBS_Mattu sCBSM = new CBS_Mattu();
		String sMainBalance = sCBS.ObtenerValorResponse(sCBSM.Servicio_queryLiteBySubscriber(sLinea),
				"bcs:MainBalance");
		Integer iMainBalance = Integer.parseInt(sMainBalance.substring(0, (sMainBalance.length()) - 1));
		driver.switchTo().frame(cambioFrame.getFrameForElement(driver, By.id("SearchClientDocumentType")));
		sleep(1000);
		...
		cCC.seleccionarCardPornumeroLinea(sLinea, driver);
		cCC.irAGestionEnCard("N\u00fameros Gratis");
		String uMainBalance = sCBS.ObtenerValorResponse(sCBSM.Servicio_queryLiteBySubscriber(sLinea),
				"bcs:MainBalance");
		Integer uiMainBalance = Integer.parseInt(uMainBalance.substring(0, (uMainBalance.length()) - 1));
	...
	@Test(groups = { "GestionesPerfilAgente", "VentadePacks", "E2E",
			"Ciclo1" }, priority = 1, dataProvider = "ventaPack500min")
	public void TS123148_CRM_Movil_REPRO_Venta_de_pack_500_Min_todo_destino_Factura_de_Venta_TD_Presencial(String sDNI,
			String sLinea, String sVentaPack) throws InterruptedException, AWTException {
		imagen = "TS123148";
		detalles = null;
	...
	@Test(groups = { "GestionesPerfilAgente", "VentadePacks", "E2E",
			"Ciclo1" }, priority = 1, dataProvider = "ventaPackA40")
	public void TS123166_CRM_Movil_REPRO_Venta_de_pack_Adelanto_Personal_40_Descuento_de_saldo_Presencial(String sDNI,
			String sLinea, String sVentaPack) throws InterruptedException, AWTException {
		imagen = "TS123166";
		detalles = null;
		detalles = imagen + "-Venta de pack-DNI:" + sDNI;
	...
	@Test(groups = { "GestionesPerfilAgente", "VentadePacks", "E2E",
			"Ciclo1" }, priority = 1, dataProvider = "ventaPackM2M")
	public void TS135801_CRM_Movil_PREVenta_de_pack_Paquete_M2M_10_MB_Factura_de_Venta_Efectivo_Presencial_PuntMa_Alta_Agente(
			String sDNI, String sLinea, String sVentaPack) throws InterruptedException, AWTException {
		imagen = "TS135801";
		detalles = null;
		detalles = imagen + "-Venta de pack-DNI:" + sDNI;
		SalesBase sale = new SalesBase(driver);
	...
	@Test(groups = { "GestionesPerfilAgente", "Modificar Datos", "E2E",
			"Ciclo3" }, dataProvider = "CuentaModificacionDeDNI")
	public void TS129328_CRM_Movil_REPRO_Modificacion_de_datos_Actualizar_datos_campo_DNI_CUIT_Cliente_FAN_Front_Agentes(
			String sDNI, String sLinea) {
		imagen = "TS129328";
		detalles = null;
	...
	public void TS135743_CRM_Movil_REPRO_Alta_Servicio_sin_costo_Restriccion_Ident_de_Llamadas_Presencial_Agente(
			String sDNI, String sLinea) throws AWTException {
		imagen = "TS135743";
		detalles = null;
		...
		driver.switchTo().frame(cambioFrame(driver, By.id("tab-default-1")));
		sleep(15000);
		// driver.findElement(By.cssSelector(".slds-button.cpq-item-has-children")).click();//Plan
		// con Tarjeta Repro button
	...
	@Test(groups = { "GestionesPerfilAgente", "ModificarDatos", "E2E",
			"Ciclo3" }, dataProvider = "CuentaModificacionDeDatos")
	public void TS129330_CRM_Movil_REPRO_Modificacion_de_datos_No_Permite_Actualizar_datos_campo_DNI_Cliente_FAN_Front_Agentes(
			String sDNI, String sLinea) {
		imagen = "TS129330";
		detalles = null;
	...
	@Test(groups = { "GestionesPerfilAgente", "Nominacion",
			"Ciclo1" }, dataProvider = "DatosNoNominacionExistenteAgente")
	public void TS134492_CRM_Movil_REPRO_No_Nominatividad_No_Valida_Identidad_Cliente_Existente_Presencial_DOC(
			String sLinea, String sDni, String sSexo, String sFnac, String sEmail) {
		imagen = "TS134492";
		detalles = null;
		detalles = imagen + "No nominacion Agente- DNI: " + sDni + "-Linea: " + sLinea;
		sleep(2000);
	...
	public void TS134817_CRM_Movil_Prepago_Vista_360_Mis_Servicios_Visualizacion_del_estado_de_los_servicios_activos_FAN_Front_OOCC_Agentes(
			String sDNI) {
		imagen = "TS134817";
		detalles = null;
		detalles = imagen + "-Vista 360 - DNI: " + sDNI;
		...
		sleep(5000);
		driver.switchTo()
				.frame(cambioFrame(driver, By.cssSelector(".via-slds-card__header.slds-card__header.headerList")));
		boolean b = false;
		for (WebElement x : driver.findElements(By.cssSelector(".slds-card.slds-m-bottom--small"))) {
			if (x.getText().toLowerCase().contains("servicio") && x.getText().toLowerCase().contains("fecha")
					&& x.getText().toLowerCase().contains("estado")) {
				b = true;
			}
		}
		Assert.assertTrue(b);
	...
	public void TS134819_CRM_Movil_Prepago_Vista_360_Distribucion_de_paneles_Informacion_del_cliente_FAN_Front_Agentes(
			String sDNI, String sNombre, String sLinea) {
		imagen = "TS134819";
		detalles = null;
		...
		Assert.assertTrue(
				tabla.getText().toLowerCase().contains("atributo") && tabla.getText().toLowerCase().contains("nps"));
		...
		Assert.assertTrue(tabla2.getText().toLowerCase().contains("actualizar datos")
				&& tabla2.getText().toLowerCase().contains("reseteo clave"));
		WebElement tabla3 = driver.findElement(By.className("left-sidebar-section-container"));
		Assert.assertTrue(
				tabla3.getText().contains("Correo Electr\u00f3nico") && tabla3.getText().contains("M\u00f3vil"));
		Assert.assertTrue(tabla3.getText().toLowerCase().contains("tel\u00e9fono alternativo")
				&& tabla3.getText().toLowerCase().contains("club personal")
				&& tabla3.getText().toLowerCase().contains("categor\u00eda"));
	}

	@Test(groups = { "GestionesPerfilAgente", "Vista360", "E2E", "Ciclo1" }, dataProvider = "CuentaVista360")
	public void TS134824_CRM_Movil_Prepago_Vista_360_Producto_Activo_del_cliente_Desplegable_FAN_Front_Agentes(
			String sDNI, String sLinea, String sNombre) {
		imagen = "TS13824";
		detalles = null;
		detalles = imagen + " -ServicioTecnico: " + sDNI;
		boolean historial = false, recarga = false, renovacion = false, servicios = false, suscripciones = false,
				inconvenientes = false, diagnostico = false, numeros = false, cambioSim = false, cambioPlan = false;
		driver.switchTo().frame(cambioFrame(driver, By.id("SearchClientDocumentType")));
		sb.BuscarCuenta("DNI", sDNI);
		driver.findElement(By.cssSelector(".slds-tree__item.ng-scope")).click();
		sleep(20000);
		...
		Assert.assertTrue(historial && recarga && renovacion && servicios && suscripciones && inconvenientes
				&& diagnostico && numeros && cambioSim && cambioPlan);
	}

	@Test(groups = { "GestionesPerfilAgente", "Vista360", "E2E", "Ciclo1" }, dataProvider = "CuentaVista360")
	public void TS134832_CRM_Movil_Prepago_Vista_360_Consulta_por_gestiones_Gestiones_no_registradas_FAN_Front_Agentes(
			String sDNI, String sLinea, String sNombre) {
		imagen = "TS13832";
		detalles = null;
		detalles = imagen + " -ServicioTecnico: " + sDNI;
	...
	@Test(groups = { "GestionesPerfilAgente", "Vista360", "E2E", "Ciclo1" }, dataProvider = "CuentaVista360")
	public void TS134823_CRM_Movil_Prepago_Vista_360_Producto_Activo_del_cliente_Datos_FAN_Front_Agentes(String sDNI,
	...
	public void TS134493_CRM_Movil_REPRO_No_Nominatividad_No_Valida_Identidad_Cliente_Existente_Presencial_Preguntas_y_Respuestas(
			String sLinea, String sDni, String sSexo) {
		driver.switchTo().frame(cambioFrame(driver, By.id("SearchClientDocumentType")));
		driver.findElement(By.id("PhoneNumber")).sendKeys(sLinea);
		driver.findElement(By.id("SearchClientsDummy")).click();
		sleep(10000);
		driver.findElement(By.id("tab-scoped-1")).findElement(By.tagName("tbody")).findElement(By.tagName("tr"))
				.click();
		sleep(3000);
		for (WebElement x : driver.findElement(By.id("tab-scoped-1")).findElement(By.tagName("tbody"))
				.findElements(By.tagName("tr"))) {
			if (x.getText().toLowerCase().contains("plan con tarjeta")
					|| x.getText().toLowerCase().contains("plan prepago nacional")) {
		...
		sleep(5000);
		((JavascriptExecutor) driver).executeScript(
				"window.scrollTo(0," + driver.findElement(By.id("Contact_nextBtn")).getLocation().y + " )");
		driver.findElement(By.id("Contact_nextBtn")).click();
