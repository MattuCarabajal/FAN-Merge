...
public class GestionesPerfilTelefonico extends TestBase {
	...
	public void init() {
		...
		try {
			...
			/*
			 * waitForClickeable(driver,By.id("tabBar")); //sleep(3000);
	...
	@Test(groups = { "GestionesPerfilTelefonico", "Recargas", "E2E" }, dataProvider = "RecargaTC") // Error despues de
																									// ingresar la
																									// tarjeta
	public void TS134332_CRM_Movil_REPRO_Recargas_Telefonico_TC_Callcenter_Financiacion(String cDNI, String cMonto,
		...
		// invoSer.PagoEnCaja("1003", accid, "2001", orden.split("-")[2],
		// orden.split("-")[1],driver);
		sleep(5000);
	...
	@Test(groups = { "GestionesPerfilTelefonico", "RenovacionDeCuota",
			"E2E" }, dataProvider = "RenovacionCuotaSinSaldo")
	public void TS130067_CRM_Movil_REPRO_Renovacion_De_Cuota_Telefonico_Descuento_De_Saldo_Sin_Credito(String sDNI,
			String sLinea) {
		imagen = "TS130067";
		detalles = null;
		...
		Assert.assertTrue(driver.findElement(By.cssSelector(".message.description.ng-binding.ng-scope")).getText()
				.equalsIgnoreCase("saldo insuficiente"));
	}

	@Test(groups = { "GestionesPerfilTelefonico", "RenovacionDeCuota",
			"E2E" }, dataProvider = "RenovacionCuotaConSaldo")
	public void TS_CRM_Movil_REPRO_Renovacion_De_Cuota_Telefonico_Descuento_De_Saldo_Con_Credito(String sDNI,
			String sLinea) {
		...
		driver.findElement(By.cssSelector(".message.description.ng-binding.ng-scope")).getText()
				.equalsIgnoreCase("la compra se realiz\u00f3 exitosamente");
	...
	@Test(groups = { "GestionesPerfilTelefonico", "E2E", "VentaDePacks",
			"Ciclo1" }, priority = 1, dataProvider = "VentaPacks")
	public void TS123314_CRM_Movil_REPRO_Venta_de_Pack_40_Pesos_Exclusivo_Para_Vos_Descuento_De_Saldo_Telefonico(
			String sDNI, String sLinea, String sVentaPack) {
		imagen = "TS123314";
		detalles = null;
		...
		CBS_Mattu cCBSM = new CBS_Mattu();
		// String sMainBalance =
		// cCBS.ObtenerValorResponse(cCBSM.Servicio_queryLiteBySubscriber(sLinea),
		// "bcs:MainBalance");
	...
	// ==================== ESTE 2 =======================================
	@Test(groups = { "GestionesPerfilTelefonico", "CambioSimCard",
			"E2E" }, priority = 1, dataProvider = "CambioSimCardTelef")
	public void TS_Cambio_Sim_Card_Store_Pick_up_Telefonico(String sDNI, String sLinea, String sEntrega,
			String sProvincia, String sLocalidad, String sPuntodeVenta) throws AWTException {
	...
	@Test(groups = { "GestionesPerfilTelefonico", "E2E", "VentaDePacks",
			"Ciclo1" }, priority = 1, dataProvider = "ventaPack50Tele")
	public void TS123157_CRM_Movil_REPRO_Venta_De_Pack_50_Min_Y_50_SMS_X_7_Dias_Factura_De_Venta_TC_Telefonico(
			String sDNI, String sLinea, String sventaPack, String cBanco, String cTarjeta, String cPromo,
			String cCuotas, String cNumTarjeta, String cVenceMes, String cVenceAno, String cCodSeg, String cTipoDNI,
			String cDNITarjeta, String cTitular) throws InterruptedException, AWTException {
		imagen = "TS123157";
		detalles = null;
		detalles = imagen + "-Venta de pack-DNI:" + sDNI;
		SalesBase sale = new SalesBase(driver);
	...
	@Test(groups = { "GestionesPerfilTelefonico", "Ajustes", "E2E" }, dataProvider = "CuentaAjustesPRE") // Rompe porque
																											// no sale
																											// el
																											// mensaje
																											// de
	...
	public void TS134811_CRM_Movil_Prepago_Vista_360_Consulta_de_Saldo_Verificar_credito_prepago_de_la_linea_FAN_Front_Telefonico(
	...
	@Test(groups = { "GestionesPerfilTelefonico", "ConsultaDeSaldo", "Ciclo1" }, dataProvider = "ConsultaSaldo")
	public void TS134813_CRM_Movil_Prepago_Vista_360_Consulta_de_Saldo_Verificar_saldo_del_cliente_FAN_Front_Telefonico(
			String sDNI, String sLinea, String sAccountKey) {
		imagen = "TS134813";
		detalles = null;
		detalles = imagen + " -Consulta de saldo - DNI: " + sDNI;
	...
	@Test(groups = { "GestionesPerfilTelefonico", "HistorialDeRecargas", "Ciclo2" }, dataProvider = "RecargasHistorias")
	public void TS135347_Historial_de_Recargas_Consultar_detalle_de_Recargas_por_Canal_TODOS_Fan_FRONT_Telefonico(
			String sDNI) {
		imagen = "TS135347";
		detalles = null;
		...
		if (driver.findElement(By.cssSelector(
			...
			Assert.assertTrue(
					driver.findElement(By.cssSelector(".slds-p-bottom--small.slds-p-left--medium.slds-p-right--medium"))
							.isDisplayed());
		} else
			Assert.assertTrue(false);
	}
	...
	public void TS134803_CRM_Movil_Prepago_Vista_360_Detalle_de_consumo_Consulta_detalle_de_consumo_SMS_FAN_Front_Telefonico(
		...
		WebElement plan = driver.findElement(By.className("summary-container")).findElements(By.className("unit-div"))
				.get(2);
		System.out.println(plan.getText());
		System.out.println(plan.getAttribute("value"));
		Assert.assertTrue(plan.isDisplayed());
		/*
		 * WebElement dmso = driver.findElements(By.xpath(
		 * "//*[@id='j_id0:j_id5']/div//div[2]/ng-include/div/div[2]/div[*]")).get(2).
		 * findElement(By.className("unit-div")); System.out.println(dmso.getText());
	...
	@Test(groups = { "GestionesPerfilTelefonico", "RenovacionDeCuota",
			"E2E" }, dataProvider = "RenovacionCuotaConSaldo")
	public void TS130068_CRM_Movil_REPRO_Renovacion_de_cuota_Telefonico_Reseteo_200_MB_por_Dia_Descuento_de_saldo_con_Credito(
			String sDNI, String sLinea) {
		imagen = "TS130068";
		detalles = null;
	...
	@Test(groups = { "GestionesPerfilTelefonico", "RenovacionDeCuota",
			"E2E" }, dataProvider = "RenovacionCuotaconSaldoConTC")
	public void TS130065_CRM_Movil_REPRO_Renovacion_de_cuota_Telefonico_Reseteo_200_MB_por_Dia_TC_con_Credito(
			String sDNI, String sLinea, String cBanco, String cTarjeta, String cPromo, String cCuotas,
			String cNumTarjeta, String cVenceMes, String cVenceAno, String cCodSeg, String cTipoDNI, String cDNITarjeta,
			String cTitular) throws AWTException {
		BasePage cambioFrameByID = new BasePage();
		imagen = "TS130065";
		detalles = null;
	...
	@Test(groups = { "GestionesPerfilTelefonico", "RenovacionDeCuota",
			"E2E" }, dataProvider = "RenovacionCuotaconSaldoConTC")
	public void TS135399_CRM_Movil_REPRO_Renovacion_de_cuota_Telefonico_Internet_50_MB_Dia_TC_con_Credito(String sDNI,
			String sLinea, String cBanco, String cTarjeta, String cPromo, String cCuotas, String cNumTarjeta,
			String cVenceMes, String cVenceAno, String cCodSeg, String cTipoDNI, String cDNITarjeta, String cTitular)
			throws AWTException {
		imagen = "TS135399";
		detalles = null;
		detalles = "Renovacion de cuota: " + imagen + "DNI: " + sDNI + "Linea: " + sLinea;
	...
	@Test(groups = { "GestionesPerfilTelefonico", "RenovacionDeCuota",
			"E2E" }, dataProvider = "RenovacionCuotaSinSaldoConTC")
	public void TS135400_CRM_Movil_REPRO_Renovacion_de_cuota_Telefonico_Internet_50_MB_Dia_TC_sin_Credito(String sDNI,
			String sLinea, String cBanco, String cTarjeta, String cPromo, String cCuotas, String cNumTarjeta,
			String cVenceMes, String cVenceAno, String cCodSeg, String cTipoDNI, String cDNITarjeta, String cTitular)
			throws AWTException {
		imagen = "135400";
	...
	@Test(groups = { "GestionesPerfilTelefonico", "RenovacionDeCuota",
			"E2E" }, dataProvider = "RenovacionCuotaConSaldo")
	public void TS135401_CRM_Movil_REPRO_Renovacion_de_cuota_Telefonico_Internet_50_MB_Dia_Descuento_de_saldo_con_Credito(
			String sDNI, String sLinea) {
		imagen = "TS135401";
		detalles = null;
		detalles = "Renovacion de cuota: " + imagen + "DNI: " + sDNI + "Linea: " + sLinea;
		...
		CBS_Mattu cCBSM = new CBS_Mattu();
		// String datosInicial =
		// cCBS.ObtenerUnidadLibre(cCBSM.Servicio_QueryFreeUnit(sLinea), "Datos
		// Libres");
		// String sMainBalance =
		// cCBS.ObtenerValorResponse(cCBSM.Servicio_queryLiteBySubscriber(sLinea),
		// "bcs:MainBalance");
	...
	public void TS100601_CRM_Movil_REPRO_FF_Alta_Posventa(String sDNI, String sLinea, String sNumeroVOZ,
			String sNumeroSMS) {
		imagen = "TS100601";
		detalles = null;
	...
	@Test(groups = { "GestionesPerfilTelefonico", "NumerosAmigos", "E2E",
			"Ciclo1" }, dataProvider = "NumerosAmigosModificacion")
	public void TS100603_CRM_Movil_REPRO_FF_Modificacion_Presencial_Posventa_Telefonico(String sDNI, String sLinea,
	...
	@Test(groups = { "GestionesPerfilTelefonico", "NumerosAmigos", "E2E",
			"Ciclo1" }, dataProvider = "NumerosAmigosBaja")
	public void TS100606_CRM_Movil_REPRO_FF_Baja_Posventa_Telefonico(String sDNI, String sLinea, String sVOZorSMS)
			throws AWTException {
		imagen = "TS100606";
		detalles = null;
		detalles = imagen + "-Numeros amigos-DNI:" + sDNI;
	...
	public void TS134796_CRM_Movil_Prepago_Vista_360_Distribucion_de_paneles_Visualizacion_e_ingreso_a_las_ultimas_gestiones_FAN_Front_Telefonico(
		...
		Assert.assertTrue(gestiones.getText().toLowerCase().contains("t\u00edtulo")
				&& gestiones.getText().contains("Fecha de creacion")
				&& gestiones.getText().toLowerCase().contains("estado")
				&& gestiones.getText().toLowerCase().contains("numero de orden"));
	}
	...
	public void TS134797_CRM_Movil_Prepago_Vista_360_Distribucion_de_paneles_Panel_Derecho_Busqueda_de_gestiones_promociones_y_gestiones_abandonadas_FAN_Front_Telefonico(
		...
		Assert.assertTrue(abandoned.getText().contains("Gestiones Abandonadas")
				&& driver.findElement(By.className("abandoned-section")).isDisplayed());
		Assert.assertTrue(promocion.getText().contains("Promociones")
				&& driver.findElement(By.className("promotions-section")).isDisplayed());
		Assert.assertTrue(busquedgestion.getText().contains("Iniciar Gestiones")
				&& driver.findElement(By.className("sidebar-actions")).isDisplayed());
	}

	@Test(groups = { "GestionesPerfilTelefonico", "VentaDePacks", "E2E",
			"Ciclo1" }, priority = 1, dataProvider = "ventaPackInternacional30SMS")
	public void TS123133_CRM_Movil_REPRO_Venta_De_Pack_internacional_30_SMS_al_Resto_del_Mundo_Factura_De_Venta_TC_Telefonico(
			...
			String sDNITarjeta, String sTitular) throws InterruptedException, AWTException {
		imagen = "TS123133";
		detalles = null;
		SalesBase sale = new SalesBase(driver);
		BasePage cambioFrameByID = new BasePage();
		...
		pagePTelefo.getMediodePago().click();
		sleep(45000);
		pagePTelefo.getOrdenSeRealizoConExito().click();// No se puede procesr (Ups, se ha producido un error en la
														// prefactura Huawei.)
		sleep(10000);
		driver.navigate().refresh();
		sleep(5000);
	...
	public void TS_134800_CRM_Movil_Prepago_Vista_360_Mis_Servicios_Visualizacion_del_estado_de_los_servicios_activos_FAN_Front_Telefonico(
			String sDNI) {
		imagen = "TS134800";
		detalles = null;
		detalles = imagen + "-Vista 360-DNI:" + sDNI;
		...
		Assert.assertTrue(a);
		///// Verificacion de todos los elementos de la tabla SERVICIOS INCLUIDOS;
		WebElement tabla = driver.findElement(
				By.cssSelector(".slds-grid.slds-wrap.slds-card.slds-m-bottom--small.slds-p-around--medium"));
		List<WebElement> elementosDeLaTabla = tabla.findElement(By.cssSelector(
				"[class='slds-grid slds-wrap slds-card slds-m-bottom--small slds-p-around--medium'] [class='slds-p-bottom--small'] "))
				.findElement(By.tagName("tbody")).findElements(By.tagName("tr"));
		System.out.println(elementosDeLaTabla.get(0).getText());
		ArrayList<String> tablaComparar = new ArrayList<String>(Arrays.asList("Contestador Personal",
				"DDI con Roaming Internacional", "Voz", "SMS Saliente", "SMS Entrante", "MMS", "Datos"));
		for (int i = 0; i < tablaComparar.size(); i++) {
			...
			// System.out.println(nombreComparar);
	...
	public void TS134799_CRM_Movil_Prepago_Vista_360_Producto_Activo_del_cliente_Desplegable_FAN_Front_Telefonico(
		...
		// Verificacion del contenido del desplegable
		ArrayList<String> elementosDesplegableIzquierdoComparar = new ArrayList<String>(
				Arrays.asList("Historial de Suspensiones", "Recarga de crédito", "Renovacion de Datos",
						"Alta/Baja de Servicios", "Suscripciones", "Inconvenientes con Recargas", "Diagnóstico",
						"Números Gratis", "Cambio SimCard", "Cambio de Plan"));
		List<WebElement> elementosDesplegableIzquierdo = desplegable.findElements(
				By.cssSelector("[class='console-flyout active flyout'] [class='community-flyout-actions-card'] ul li"));
		int i = 0;
	...
	@Test(groups = { "GestionesPerfilTelefonico", "ModificarDatos", "E2E",
			"Ciclo3" }, dataProvider = "CuentaModificacionDeDatos")
	public void TS129336_CRM_Movil_REPRO_Modificacion_de_datos_Actualizar_datos_campo_Correo_Electronico_Cliente_FAN_Front_Telefonico(
			String sDNI, String sLinea) {
		imagen = "TS129336";
		detalles = null;
	...
	@Test(groups = { "GestionesPerfilTelefonico", "ModificarDatos", "E2E",
			"Ciclo3" }, dataProvider = "CuentaModificacionDeDatos")
	public void TS121104_CRM_Movil_REPRO_Modificacion_de_datos_No_Actualizar_datos_Cliente_FAN_Front_Telefonico(
			String sDNI, String sLinea) {
		imagen = "TS121104";
		detalles = null;
	...
	@Test(groups = { "GestionesPerfilTelefonico", "ModificarDatos", "E2E",
			"Ciclo3" }, dependsOnMethods = "TS121104_CRM_Movil_REPRO_Modificacion_de_datos_No_Actualizar_datos_Cliente_FAN_Front_Telefonico")
	...
	@Test(groups = { "GestionesPerfilTelefonico", "HistorialDeRecargas", "Ciclo2" }, dataProvider = "RecargasHistorias")
	public void TS134789_CRM_Movil_Prepago_Historial_de_Recargas_Consultar_detalle_de_Recargas_con_Beneficios_Fan_FRONT_Telefonico(
			String sDNI) {
		imagen = "TS134789";
		detalles = null;
	...
	@Test(groups = { "GestionesPerfilTelefonico", "HistorialDeRecargas", "Ciclo2" }, dataProvider = "RecargasHistorias")
	public void TS134790_CRM_Movil_Prepago_Historial_de_Recargas_Consultar_detalle_de_Recargas_Sin_Beneficios_Fan_FRONT_Telefonico(
			String sDNI) {
		imagen = "TS134790";
		detalles = null;
		detalles = imagen + "-HistorialDeRecargasTelefonico-DNI:" + sDNI;
	...
	public void TS121138_CRM_Movil_REPRO_Ajuste_Credito_FAN_Front_Telefonico_BO(String sDNI, String sLinea) {
		...
		if (TestBase.urlAmbiente.contains("sit")) {
			...
			datosOrden.add("Inconvenientes con cargos tasados y facturados, orden numero: " + orden
					+ " con numero de DNI: " + sDNI);
			Assert.assertTrue(cc.verificarOrden(orden));
		} else {
			String orden = driver.findElement(By.xpath("//*[@id=\"txtSuccessConfirmation\"]/div/p/p"))
					.findElement(By.tagName("strong")).getText();
			datosOrden.add("Inconvenientes con cargos tasados y facturados, numero de orden: " + orden
	...
	public void TS135376_CRM_Movil_Prepago_Otros_Historiales_Historial_de_ajustes_Seleccion_de_Fechas_Ajuste_positivo_FAN_Front_Telefonico(
			String sDNI, String sLinea) {
		imagen = "TS135376";
		...
		driver.findElement(By.cssSelector(
				...
				.click();
		sleep(3000);
		List<WebElement> tablas = driver
				.findElement(By.cssSelector(".slds-p-bottom--small.slds-p-left--medium.slds-p-right--medium"))
				.findElements(By.cssSelector(".ng-pristine.ng-untouched.ng-valid.ng-empty"));
	...
	@Test(groups = { "GestionesPerfilTelefonico", "E2E", "VentaDePacks",
			"Ciclo1" }, priority = 1, dataProvider = "packUruguay")
	public void TS123143_CRM_Movil_REPRO_Venta_de_pack_100MB_Uruguay_Descuento_de_saldo_Telefonico(String sDNI,
			String sLinea, String packUruguay) throws InterruptedException, AWTException {
		imagen = "TS123143";
		detalles = null;
		CBS_Mattu cCBSM = new CBS_Mattu();
		CBS cCBS = new CBS();
	...
	@Test(groups = { "GestionesPerfilTelefonico", "Vista360", "Ciclo2" }, dataProvider = "CuentaVista360")
	public void TS135351_CRM_Movil_Prepago_Vista_360_Consulta_de_Gestiones_Gestiones_abiertas_Plazo_No_vencido_Consulta_registrada_CASOS_FAN_Telefonico(
			String sDNI, String sLinea, String sNombre) {
		imagen = "TS135351";
		...
		driver.findElement(By.cssSelector(
				...
				.click();
		sleep(9000);
		String nroCaso = driver.findElement(By.cssSelector(".slds-p-bottom--small")).findElement(By.tagName("table"))
				.findElement(By.tagName("tbody")).findElement(By.tagName("tr")).findElements(By.tagName("td")).get(2)
				.findElement(By.tagName("div")).findElement(By.tagName("a")).getText();
		driver.switchTo().defaultContent();
		sb.cerrarPestaniaGestion(driver);
		...
		if (estado.getText().toLowerCase().contains("en espera de ejecuci\u00f3n")
				|| (estado.getText().toLowerCase().contains("informada")
						|| (estado.getText().toLowerCase().contains("resuelta exitosa"))))
			gestion = true;
		Assert.assertTrue(gestion);
	}

	@Test(groups = { "GestionesPerfilTelefonico", "Vista360", "Ciclo2" }, dataProvider = "CuentaVista360")
	public void TS135356_CRM_Movil_Prepago_Vista_360_Consulta_de_Gestiones_Gestiones_abiertas_Plazo_No_vencido_Consulta_registrada_ORDENES_FAN_Telefonico(
			String sDNI, String sLinea, String sNombre) {
		imagen = "TS135356";
		detalles = null;
		detalles = imagen + "-Vista 360 - DNI:" + sDNI;
		...
		nroCaso.findElements(By.tagName("td")).get(2).findElement(By.tagName("div")).findElement(By.tagName("a"))
				.click();
	...
	@Test(groups = { "GestionesPerfilTelefonico", "Vista360", "E2E", "ConsultaPorGestion",
			"Ciclo2" }, dataProvider = "CuentaVista360")
	public void TS134808_CRM_Movil_Prepago_Vista_360_Consulta_por_gestiones_Gestiones_Cerradas_Informacion_brindada_FAN_Front_Telefonico(
			String sDNI, String sLinea, String sNombre) {
		imagen = "TS134808";
		detalles = null;
		detalles = imagen + "-Vista 360 - DNI:" + sDNI;
		...
		driver.switchTo().frame(cambioFrame(driver, By.cssSelector(
				".slds-table.slds-table--bordered.slds-table--resizable-cols.slds-table--fixed-layout.via-slds-table-pinned-header")));
		sleep(5000);
		WebElement tabla = driver.findElement(By.cssSelector(
				".slds-table.slds-table--bordered.slds-table--resizable-cols.slds-table--fixed-layout.via-slds-table-pinned-header"));
		Assert.assertTrue(tabla.isDisplayed());
	}

	@Test(groups = { "GestionesPerfilTelefonico", "Nominacion",
			"Ciclo1" }, dataProvider = "DatosNoNominacionNuevoTelefonico")
	public void TS85111_CRM_Movil_REPRO_No_Nominatividad_No_Valida_Identidad_Cliente_Nuevo_Telefonico_Preguntas_y_Respuestas(
	...
	public void TS100608_CRM_Movil_REPRO_FF_No_Alta_Posventa_Amigo_No_Personal_Telefonico(String sDNI, String sLinea,
			String sNumeroVOZ, String sNumeroSMS) {
		imagen = "TS100608";
		detalles = null;
		detalles = imagen + "-Numeros amigos - DNI:" + sDNI;
	...
	public void TS100610_CRM_Movil_REPRO_FF_No_Modificacion_Posventa_Telefonico(String sDNI, String sLinea,
			String sNumeroVOZ, String sNumeroSMS) {
		imagen = "TS100610";
		detalles = null;
		detalles = imagen + "-Numeros Amigos - DNI:" + sDNI;
	...
	public void TS100611_CRM_Movil_REPRO_FF_No_Baja_Posventa_Telefonico(String sDNI, String sLinea, String sVOZorSMS)
			throws AWTException {
		imagen = "TS100611";
		detalles = null;
		detalles = imagen + "-Numeros Amigos - DNI:" + sDNI;
	...
	@Test(groups = { "GestionesPerfilTelefonico", "DiagnosticoInconvenientes", "E2E",
			"Ciclo3" }, dataProvider = "Diagnostico")
	public void TS111300_CRM_Movil_REPRO_Diagnostico_SVA_Telefonico_SMS_Saliente_SMS_a_fijo_Geo_No_Ok_Desregistrar(
		...
		Assert.assertTrue(driver.findElement(By.cssSelector(".imgItemContainer.ng-scope")).getText()
				.equalsIgnoreCase("Desregistrar"));
	}

	@Test(groups = { "GestionesPerfilTelefonico", "DiagnosticoInconvenientes", "E2E",
			"Ciclo3" }, dataProvider = "Diagnostico")
	public void TS112441_CRM_Movil_REPRO_Diagnostico_SVA_Telefonico_SMS_Entrante_No_Recibe_De_Un_Numero_En_Particular_Geo_Ok_Rojo(
			String sDNI, String sLinea) throws Exception {
		imagen = "TS112441";
		detalles = null;
		detalles = imagen + " -Diagnostico Inconveniente - DNI: " + sDNI;
		...
		Assert.assertTrue(driver
				.findElement(
						By.cssSelector(".slds-page-header__title.vlc-slds-page-header__title.slds-truncate.ng-binding"))
				.getText().contains("Saldo Insuficiente"));

	}

	@Test(groups = { "GestionesPerfilTelefonico", "BaseDeConocimiento", "Ciclo3" }, dataProvider = "CuentaVista360")
	public void TS118160_CRM_REPRO_BDC_Customer_Care_Actualizacion_de_Datos_Perfil_Telefonico_Acceso_base_de_conocimientos_dentro_OS(
		...
		Assert.assertTrue(driver.findElement(By.className("vlc-slds-knowledge-list-item")).getText()
				.contains("Actualizaci\u00f3n de Datos"));
	}

	@Test(groups = { "GestionesPerfilTelefonico", "ABMDeServicios", "E2E", "Ciclo3" }, dataProvider = "AltaServicios")
	public void TS135753_CRM_Movil_REPRO_Alta_Servicio_sin_costo_Voice_Mail_con_Clave_y_Transferencia_de_Llamada_Telefonico(
		...
		// Mail con Clave"));
		// Assert.assertTrue(gGF.FlowConsultaServicioInactivo(driver, sLinea,
		...
		ppt.altaBajaServicioContestador("Alta", "servicios basicos general movil", "nada", "Transferencia de Llamadas",
				driver);
	...
	public void TS135848_CRM_Movil_REPRO_Baja_de_Servicio_sin_costo_Contestador_Personal_Telefonico(String sDNI,
	...
	// =================== ESTEEEEEE 1 ==========
	@Test(groups = { "GestionesPerfilTelefonico", "CambioSimCard", "Ciclo 3",
			"E2E" }, priority = 1, dataProvider = "SimCardSiniestroTelef")
	public void TS134427_CRM_Movil_REPRO_Cambio_de_simcard_con_costo_Voluntario_Telefonico_Store_pickUp_Con_Siniestro_Telef(
			String sDNI, String sLinea, String sEntrega, String sProvincia, String sLocalidad, String sPuntodeVenta)
			throws AWTException {
		imagen = "134427";
		detalles = null;
		detalles = imagen + "-Telef-DNI:" + sDNI;
	...
	@Test(groups = { "GestionesPerfilTelefonico", "DiagnosticoInconvenientes", "Ciclo 3",
			"E2E" }, priority = 1, dataProvider = "Diagnostico")
	public void TS119281_CRM_Movil_REPRO_Diagnostico_de_Datos_Valida_Red_y_Navegacion_Motivo_de_contacto_No_puedo_Navegar_CONCILIACION_EXITOSA_NO_BAM_Telefonico(
			String sDNI, String sLinea) {
		imagen = "TS119281";
		detalles = null;
		detalles = imagen + " -Diagnostico Inconveniente - DNI: " + sDNI;
		...
		WebElement caso = driver.findElement(By.id("IncorrectCategoriesMessage")).findElement(By.tagName("div"))
		...
		WebElement gest = driver.findElement(By.id("Case_body")).findElement(By.tagName("table"))
				.findElement(By.tagName("tbody")).findElement(By.cssSelector(".dataRow.even.last.first"))
	...
	public void TS130755_CRM_REPRO_BDC_Customer_Care_Problemas_con_Recargas_PerfilTelefonico_Articulo_de_Medios_de_Recargas(
		...
		for (WebElement x : driver
				.findElements(By.cssSelector(".slds-form-element.slds-lookup.vlc-slds-knowledge-component.ng-scope"))) {
	...
	public void TS104332_CRM_Movil_Repro_Problemas_con_Recarga_Telefonico_Tarjeta_Scratch_Caso_Nuevo_Tarjeta_Activa_y_Disponible(
	...
	@Test(groups = { "GestionesPerfilTelefonico", "HistorialDeRecargas", "E2E",
			"Ciclo2" }, dataProvider = "RecargasHistorias")
	...
	public void TS134847_CRM_Movil_Prepago_Historial_de_Recargas_Consultar_detalle_de_Recargas_por_Canal_Atencion_al_cliente_Fan_FRONT_Telefonico(
			String sDNI, String sLinea) {
		imagen = "TS134847";
		detalles = imagen + "-Historial De Recarga-DNI:" + sDNI;
		driver.switchTo().frame(cambioFrame(driver, By.id("SearchClientDocumentType")));
		...
		driver.switchTo().frame(cambioFrame(driver, By.id("text-input-03")));
		driver.findElement(By.id("text-input-03")).click();
		List<WebElement> atencion = driver.findElement(By.cssSelector(".slds-dropdown__list.slds-dropdown--length-5"))
				.findElements(By.tagName("li"));
	...
	@Test(groups = { "GestionesPerfilTelefonico", "Ciclo 3", "E2E",
			"DiagnosticoInconveniente" }, priority = 1, dataProvider = "Diagnostico")
	public void TS119245_CRM_Movil_REPRO_Diagnostico_de_Voz_Valida_Red_y_Navegacion_Motivo_de_contacto_No_puedo_Llamar_desde_otro_pais_Conciliacion_Exitosa_Telefonico(
			String sDNI, String sLinea) {
		imagen = "TS119245";
		detalles = null;
		detalles = imagen + " -Diagnostico Inconveniente - DNI: " + sDNI;
	...
	public void TS129327_CRM_Movil_REPRO_Modificacion_de_datos_Actualizar_datos_campo_DNI_CUIT_Cliente_FAN_Front_Telefonico(
			String sDNI, String sLinea) {
		imagen = "TS129327";
		detalles = null;
		detalles = imagen + "-Modificacion de datos - DNI:" + sDNI;
	...
	@Test(groups = { "GestionesPerfilTelefonico", "HistorialDeRecargas", "E2E",
			"Ciclo1" }, dataProvider = "RecargasHistorias")
	public void TS135477_CRM_Movil_Prepago_Historial_de_Packs_Nombre_del_Pack_Plan_Internet_40_Mb_FAN_Front_Telefonico(
			String sDNI) {
		imagen = "TS135477";
		detalles = null;
		detalles = imagen + "-HistorialDePacksTelefonico - DNI:" + sDNI;
	...
	@Test(groups = { "GestionesPerfilTelefonico", "ResumenDeCuenta", "E2E",
			"Ciclo4" }, dataProvider = "CuentaModificacionDeDatos")
	public void TS135434_CRM_Movil_Prepago_Resumen_de_Cuenta_Corriente_Columnas_de_informacion_Comprobantes_FAN_Front_Telefonico(
			String sDNI, String sLinea) {
		imagen = "TS135434";
		detalles = null;
	...
	@Test(groups = { "GestionesPerfilTelefonico", "ModificarDatos", "E2E",
			"Ciclo3" }, dataProvider = "CuentaModificacionDeDatos")
	public void TS129333_CRM_Movil_REPRO_Modificacion_de_datos_No_Permite_Actualizar_datos_campo_DNI_Cliente_FAN_Front_Telefonico(
			String sDNI, String sLinea) {
		imagen = "TS129333";
		detalles = null;
		...
		boolean a = false;
		for (WebElement x : driver.findElements(By.cssSelector(
				".slds-form-element.vlc-flex.vlc-slds-text-block.vlc-slds-rte.ng-pristine.ng-valid.ng-scope"))) {
	...
	public void TS135435_CRM_Movil_Prepago_Resumen_de_Cuenta_Corriente_Columnas_de_informacion_Pagos_FAN_Front_Telefonico(
			String sDNI, String sLinea, String sNombre, String sEmail, String sMovil) {
		imagen = "TS135435";
		detalles = null;
		detalles = imagen + " -Diagnostico Inconveniente - DNI: " + sDNI;
		...
		driver.findElement(By.cssSelector(
				...
				.click();
		sleep(10000);
		WebElement compro = driver.findElement(By.cssSelector(
	...
	@Test(groups = { "GestionesPerfilTelefonico", "ResumenDeCuenta", "E2E", "Ciclo2" }, dataProvider = "CuentaVista360")
	public void TS135436_CRM_Movil_Prepago_Resumen_de_Cuenta_Corriente_Detalle_ampliado_registro_de_Pago_FAN_Front_Telefonico(
			String sDNI, String sLinea, String sNombre, String sEmail, String sMovil) {
		imagen = "TS135436";
		detalles = null;
		detalles = imagen + " -Diagnostico Inconveniente - DNI: " + sDNI;
		...
		driver.findElement(By.cssSelector(
				...
				.click();
		sleep(10000);
		WebElement Tabla = driver.findElement(By.className("slds-p-bottom--small")).findElement(By.tagName("table"))
				.findElement(By.tagName("tbody")).findElement(By.tagName("tr")).findElements(By.tagName("td")).get(5);
		Tabla.click();
		sleep(7000);
		Assert.assertTrue(true);
	}

	@Test(groups = { "GestionesPerfilTelefonico", "CambioSimcardDer",
			"E2E" }, priority = 1, dataProvider = "SimCardSiniestroOfCom")
	public void TS134392_TELEF_CRM_Movil_REPRO_Cambio_de_simcard_sin_costo_Siniestro_Telefonico_Store_pickUp_Con_entega_de_pedido(
			String sDNI, String sLinea) {
		imagen = "134392";
		detalles = null;
	...
	public void TS119272_CRM_Movil_PRE_Diagnostico_de_Datos_Valida_Red_y_Navegacion_Motivo_de_contacto_No_puedo_Navegar_SIN_CUOTA_NO_BAM(
			String sDNI, String sLinea) throws Exception {
		imagen = "TS119272";
		detalles = null;
		...
		WebElement MediosDispon = driver.findElement(By.className("ng-binding"))
				.findElement(By.xpath("//*[@id='UnavailableQuotaMessage']/div/p/p[1]/span"));
		Assert.assertTrue(
				MediosDispon.getText().equalsIgnoreCase("Prob\u00e1 realizar una recarga o comprar un pack de datos"));
		String caso = driver.findElement(By.xpath("//*[@id='UnavailableQuotaMessage']/div/p/p[2]/span/strong"))
				.getText();
	...
	@Test(groups = { "GestionesPerfilTelefonico", "Nominacion",
			"Ciclo1" }, dataProvider = "DatosNoNominacionNuevoTelefonicoPasaporte")
	public void TS128437_CRM_Movil_REPRO_No_Nominatividad_Telefonico_Pasaporte(String sLinea, String sPasaporte,
			String sNombre, String sApellido, String sSexo, String sFnac, String sEmail, String sFperm) {
		imagen = "TS128437";
		detalles = null;
		...
		Assert.assertTrue(driver.findElement(By.className("ng-binding")).getText().equalsIgnoreCase(
				"No se puede continuar con la operaci\u00f3n. Por favor, dirijase a una oficina comercial."));
	}
	...
	@Test(groups = { "ProblemasConRecargas", "GestionesPerfilTelefonico", "E2E",
			"Ciclo3" }, dataProvider = "CuentaProblemaRecarga")
	public void TS104338_CRM_Movil_REPRO_Problemas_con_Recarga_Telefonico_Tarjeta_Scratch_Caso_Nuevo_Quemada(
			String sDNI, String sLinea) {
		imagen = "TS104338";
	...
	@Test(groups = { "ProblemasConRecargas", "GestionesPerfilTelefonico", "E2E",
			"Ciclo3" }, dataProvider = "CuentaProblemaRecarga")
	public void TS104330_CRM_Movil_REPRO_Problemas_con_Recarga_Telefonico_Tarjeta_Scratch_Caso_Existente(String sDNI,
			String sLinea) {
		imagen = "TS104330";
		boolean gestion = false;
		String datoViejo = cbs.ObtenerValorResponse(cbsm.Servicio_queryLiteBySubscriber(sLinea), "bcs:MainBalance");
	...
	@Test(groups = { "GestionesPerfilTelefonico", "HistorialDeRecargas", "Ciclo2" }, dataProvider = "RecargasHistorias")
	public void TS134844_CRM_Movil_Prepago_Historial_de_Recargas_Consultar_detalle_de_Recargas_por_Canal_IVR_Fan_FRONT_Telefonico(
			String sDNI) {
		imagen = "TS134844";
	...
	public void TS98435_CRM_Movil_REPRO_Suspension_por_Siniestro_Robo_Linea_Titular_Telefonico(String sDNI,
	...
	@Test(groups = { "Suspension", "GestionesPerfilOficina", "E2E", "Ciclo3" }, dataProvider = "CuentaSuspension")
	public void TS98437_CRM_Movil_Prepago_Suspension_por_Siniestro_Robo_Linea_No_Titular_Telefonico(String sDNI,
			String sLinea, String sProvincia, String sCiudad, String sPartido) {
		imagen = "TS98437";
		boolean gestion = false;
		driver.switchTo().frame(cambioFrame(driver, By.id("SearchClientDocumentType")));
	...
	@Test(groups = { "GestionesPerfilTelefonico", "HistorialDeRecargas", "Ciclo2" }, dataProvider = "HistoriaRecarga")
	public void TS134845_CRM_Movil_Prepago_Historial_de_Recargas_Consultar_detalle_de_Recargas_por_Canal_SMS_Fan_FRONT_Telefonico(
			String sDNI, String sLinea) {
		imagen = "TS134845";
		detalles = imagen + "-Historial De Recarga-DNI:" + sDNI;
		driver.switchTo().frame(cambioFrame(driver, By.id("SearchClientDocumentType")));
	...
	@Test(groups = { "GestionesPerfilTelefonico", "HistorialDeRecargas", "Ciclo2" }, dataProvider = "HistoriaRecarga")
	public void TS134846_CRM_Movil_Prepago_Historial_de_Recargas_Consultar_detalle_de_Recargas_por_Canal_ROL_Fan_FRONT_Telefonico(
			String sDNI, String sLinea) {
		imagen = "TS134846";
		detalles = imagen + "-Historial De Recarga-DNI:" + sDNI;
		driver.switchTo().frame(cambioFrame(driver, By.id("SearchClientDocumentType")));
	...
	@Test(groups = { "GestionesPerfilTelefonico", "HistorialDeRecargas", "Ciclo2" }, dataProvider = "HistoriaRecarga")
	public void TS134839_CRM_Movil_Prepago_Historial_de_Recargas_Consultar_detalle_de_Recargas_por_Fecha_Fan_FRONT_Telefonico(
			String sDNI, String sLinea) {
		imagen = "TS134839";
		detalles = null;
		detalles = imagen + "-Historial De Recarga-DNI:" + sDNI;
	...
	@Test(groups = { "GestionesPerfilTelefonico", "HistorialDeRecargas", "Ciclo2" }, dataProvider = "RecargasHistorias")
	public void TS135475_CRM_Movil_Prepago_Historial_de_Packs_Nombre_del_Pack_Plan_Familia_FAN_Front_Telefonico(
			String sDNI) {
		imagen = "TS135475";
	...
	@Test(groups = { "GestionesPerfilTelefonico", "Diagnostico/Inconvenientes" }, dataProvider = "Diagnostico")
	public void TS105845_CRM_Movil_REPRO_Autogestion_APP_Abre_aplicacion_y_cierra_automaticamente_No_Resuelto(
	...
	public void TS_134802_CRM_Movil_Prepago_Vista_360_Detalle_de_consumo_Consulta_visualizacion_y_busqueda_de_los_distintos_consumos_realizados_por_el_cliente_FAN_Front_Telefonico(
			String sDNI, String sLinea, String sNombre) {
		imagen = "TS134802";
		detalles = null;
		...
		WebElement periodosDeConsulta = driver.findElement(By.cssSelector(
				"[class='slds-grid slds-wrap slds-grid--pull-padded slds-m-around--medium slds-p-around--medium negotationsfilter'] [class='slds-p-horizontal--small slds-size--1-of-1 slds-medium-size--2-of-8 slds-large-size--2-of-8'] [class='slds-dropdown slds-dropdown--left'] [class='slds-dropdown__list slds-dropdown--length-3']"));
...
//				+ driver.findElement(By.className("slds-select_container")).getLocation().y + " )");
...
//		Assert.assertTrue(filt.getText().contains("10"));///////////////////////////////////
	...
	public void TS_134798_CRM_Movil_Prepago_Vista_360_Producto_Activo_del_cliente_Datos_FAN_Front_Telefonico(
			String sDNI, String sLinea, String sNombre) {
		imagen = "TS134798";
		detalles = null;
	...
	@Test(groups = { "GestionesPerfilTelefonico", "Vista360", "E2E", "Ciclo1" }, dataProvider = "CuentaVista360")
	public void TS_134801_CRM_Movil_Prepago_Vista_360_Mis_Servicios_Visualizacion_del_estado_de_los_Productos_activos_FAN_Front_Telefonico(
			String sDNI, String sLinea, String sNombre) {
		imagen = "TS134801";
		detalles = null;
		detalles = imagen + " -ServicioTecnico: " + sDNI;
	...
	@Test(groups = { "GestionesPerfilTelefonico", "Vista360", "E2E", "Ciclo1" }, dataProvider = "CuentaVista360")
	public void TS134809_CRM_Movil_Prepago_Vista_360_Consulta_por_gestiones_Gestiones_no_registradas_FAN_Front_Telefonico(
			String sDNI, String sLinea, String sNombre) {
		imagen = "TS134809";
		detalles = null;
		detalles = imagen + " -ServicioTecnico: " + sDNI;
		...
		driver.findElement(By.id("text-input-id-1")).click();
		driver.findElement(
				By.cssSelector(".slds-button.slds-button--icon-container.nds-button.nds-button_icon-container"))
				.click();
		...
		sleep(3000);
		List<WebElement> tipo = driver
				.findElement(By.cssSelector(".slds-dropdown.slds-dropdown--left.resize-dropdowns"))
				.findElements(By.tagName("li"));
		...
		sleep(9000);
		Boolean asd = true;
		List<WebElement> cuadro = driver.findElement(By.cssSelector(
				".slds-table.slds-table--bordered.slds-table--resizable-cols.slds-table--fixed-layout.via-slds-table-pinned-header"))
				.findElement(By.tagName("tbody")).findElements(By.tagName("tr"));
	...
	public void TS134342_CRM_Movil_PRE_Baja_de_Servicio_sin_costo_Llamadas_WiFi_Telefonico(String sDNI, String sLinea)
			throws AWTException {
		imagen = "TS134342";
		detalles = null;
		detalles = imagen + "-BajaServicio-DNI:" + sDNI;
	...
	@Test(groups = { "GestionesPerfilTelefonico", "E2E", "Ciclo3", "ABMDeServicios" }, dataProvider = "BajaServicios")
	public void TS134345_CRM_Movil_PRE_Baja_de_Servicio_sin_costo_DDI_con_Roaming_Internacional_Telefonico(String sDNI,
			String sLinea) throws AWTException {
		imagen = "TS134345";
		detalles = null;
		detalles = imagen + "-BajaServicio-DNI:" + sDNI;
	...
	@Test(groups = { "GestionesPerfilTelefonico", "E2E", "Ciclo3", "ABMDeServicios" }, dataProvider = "BajaServicios")
	public void TS134346_CRM_Movil_PRE_Baja_de_Servicio_sin_costo_DDI_sin_Roaming_Internacional_Telefonico(String sDNI,
			String sLinea) throws AWTException {
		imagen = "TS134346";
		detalles = null;
	...
	public void TS134359_CRM_Movil_PRE_Alta_Servicio_sin_costo_Llamadas_WiFi_Telefonico(String sDNI, String sLinea)
			throws AWTException {
		imagen = "TS134359";
		detalles = null;
		detalles = imagen + "-AltaServicio-DNI:" + sDNI;
	...
	public void TS134362_CRM_Movil_PRE_Alta_Servicio_sin_costo_DDI_con_Roaming_Internacional_Telefonico(String sDNI,
			String sLinea) throws AWTException {
		imagen = "TS134362";
		detalles = null;
		detalles = imagen + "-AltaServicio-DNI:" + sDNI;
	...
	@Test(groups = { "GestionesPerfilOficina", "E2E", "Ciclo3", "ABMDeServicios" }, dataProvider = "AltaServicios")
	public void TS134363_CRM_Movil_PRE_Alta_Servicio_sin_costo_DDI_sin_Roaming_Internacional_Telefonico(String sDNI,
			String sLinea) throws AWTException {
		imagen = "TS134363";
	...
	public void TS134794_CRM_Movil_Prepago_Vista_360_Distribucion_de_paneles_Informacion_del_cliente_FAN_Front_Telefonico(
		...
		// Visualizacion panel izquierdo superior Datos de Cliente
		WebElement wProfileBoxDetails = driver.findElement(By.className("profile-box-details"));
		// System.out.println("Name: " +
		// wProfileBoxDetails.findElement(By.cssSelector(".slds-text-heading_large.title-card")).findElement(By.tagName("h1")).getText().toLowerCase()
		Assert.assertTrue(wProfileBoxDetails.findElement(By.tagName("h1")).getText().toLowerCase()
				.contains(sNombre.toLowerCase())); // Changed
		String sWebDNI = wProfileBoxDetails.findElement(By.className("detail-card")).findElement(By.tagName("tbody"))
				.findElements(By.tagName("tr")).get(1).findElements(By.tagName("td")).get(1).getText();
		Assert.assertTrue(sWebDNI.equals(sDNI));
		Assert.assertTrue(sWebDNI.matches("[0-9]+"));
		String npsText = wProfileBoxDetails.findElement(By.className("detail-card")).findElement(By.tagName("tbody"))
				.findElements(By.tagName("tr")).get(2).findElements(By.tagName("td")).get(0).getText();
		...
		// Visualizacion panel izquierdo - Datos personales y Segmentacion
		driver.findElement(By.xpath(
				"//div[@class='left-sidebar-section-header'] //span[contains(text(),'Datos Personales')] /.. /.. /.. /.. /.."))
				.click();
		String headerDatosPersonales = driver
		...
		driver.findElement(By.xpath(
				"//div[@class='left-sidebar-section-header'] //span[contains(text(),'Segmentaci')] /.. /.. /.. /.. /.."))
				.click();
		String headerSegmentacion = driver
				.findElement(
						By.xpath("//div[@class='left-sidebar-section-header'] //span[contains(text(),'Segmentaci')]"))
				.getText();
		...
		// WebElement datosPersonales = panelesIzquierdos.get(0);
		// WebElement segmentacion = panelesIzquierdos.get(1);
		...
		ArrayList<String> datosPersonalesComparar = new ArrayList<String>(Arrays.asList("Correo Electr\u00f3nico:",
				"M\u00f3vil:", "Tel\u00e9fono alternativo:", "Club Personal:", "Categor\u00eda:"));
		...
		for (int i = 0; i < segmentacion.size(); i++) {
			...
			if (textoDelCampo.equals("Segmento:")) {
				String valorDelCampo = driver.findElement(By.xpath(
						"/html/body/div/div[1]/ng-include/div[4]/ng-include/div/div[2]/table[1]/tbody/tr/td/div[2]"))
						.getText();
				System.out.println("Valor es : " + valorDelCampo);
		...
		// sleep(5000);
		// WebElement wL =
		// driver.findElements(By.className("left-sidebar-section-container")).get(1);
		// // System.out.println("Segmento :" +
		// //
		// wL.findElements(By.tagName("table")).get(0).findElement(By.tagName("tbody")).findElement(By.tagName("td")).findElement(By.tagName("div")).getText());
		// Assert.assertTrue(wL.findElements(By.tagName("table")).get(0).findElement(By.tagName("tbody"))
		// .findElement(By.tagName("td")).findElement(By.tagName("div")).getText().equalsIgnoreCase("Segmento:"));
		// // System.out.println("Alta Reciente :" +
		// //
		// wL.findElements(By.tagName("table")).get(0).findElement(By.tagName("tbody")).findElement(By.tagName("td")).findElements(By.tagName("div")).get(1).getText());
		// Assert.assertTrue(wL.findElements(By.tagName("table")).get(0).findElement(By.tagName("tbody"))
		// .findElement(By.tagName("td")).findElements(By.tagName("div")).get(1).getText().toLowerCase()
		// .contains("alta reciente"));
		// // System.out.println("Atributos :" +
		// //
		// wL.findElements(By.tagName("table")).get(1).findElement(By.tagName("tbody")).findElement(By.tagName("td")).findElement(By.tagName("div")).getText());
		// Assert.assertTrue(wL.findElements(By.tagName("table")).get(1).findElement(By.tagName("tbody"))
		// .findElement(By.tagName("td")).findElement(By.tagName("div")).getText().equalsIgnoreCase("Atributos:"));
	}

	@Test(groups = { "GestionesPerfilTelefonico", "ResumenDeCuenta", "E2E",
			"Ciclo4" }, dataProvider = "CuentaReintegros")
	public void TS135432_CRM_Movil_REPRO_Resumen_de_Cuenta_Corriente_Verificacion_de_vista_de_Resumen_de_Cuenta_Corriente_FAN_Front_Telefonico(
			String sDNI) {
		imagen = "TS135432";
		detalles = null;
		...
		sleep(5000);
		driver.switchTo().frame(cambioFrame(driver, By.className("card-top")));
		buscarYClick(driver.findElements(By.className("slds-text-body_regular")), "equals",
				"resumen de cuenta corriente");
		sleep(4000);
		driver.switchTo().frame(cambioFrame(driver, By.cssSelector(
				".slds-button.slds-button--brand.filterNegotiations.slds-p-horizontal--x-large.slds-p-vertical--x-small.secondaryFont")));
		WebElement saldo = driver.findElement(By.cssSelector(".slds-text-heading--medium.secondaryFont"));
		WebElement fechas = driver.findElement(By.cssSelector(
				".slds-grid.slds-wrap.slds-grid--pull-padded.slds-m-around--medium.slds-p-around--medium.negotationsfilter"));
		WebElement boton = driver.findElement(By.cssSelector(
				".slds-button.slds-button--brand.filterNegotiations.slds-p-horizontal--x-large.slds-p-vertical--x-small.secondaryFont"));
	...
	public void TS85113_CRM_Movil_REPRO_No_Nominatividad_Numero_Limite_De_Lineas_Cliente_Existente_Telefonico(
	...
	public void TS85114_CRM_Movil_REPRO_No_Nominatividad_Por_Fraude_Cliente_Existente_Presencial(String sLinea,
			String sDni) {
		imagen = "TS85114";
		detalles = null;
		detalles = imagen + " -Nominacion: " + sDni + "- Linea: " + sLinea;
	...
	@Test(groups = { "GestionesPerfilTelefonico", "Nominacion",
			"Ciclo1" }, dataProvider = "DatosNoNominacionNuevoFraudeTelef")
	public void TS85112_CRM_Movil_REPRO_No_Nominatividad_Por_Fraude_Cliente_Nuevo_Telefonico(String sLinea,
			String sDni) {
		imagen = "TS85112";
		detalles = null;
		detalles = imagen + " -Nominacion: " + sDni + "- Linea: " + sLinea;
	...
	@Test(groups = { "GestionesPerfilTelefonico", "Nominacion",
			"Ciclo1" }, dataProvider = "DatosNoNominacionExistenteTelefonico")
	public void TS134494_CRM_Movil_REPRO_No_Nominatividad_No_Valida_Identidad_Cliente_Existente_Telefonico_Preguntas_Y_Respuestas(
			String sLinea, String sDni, String sSexo) {
		imagen = "TS134494";
		detalles = null;
		detalles = imagen + "No nominacion Agente- DNI: " + sDni + "-Linea: " + sLinea;
		sleep(2000);
	...
	public void TS135439_CRM_Movil_REPRO_Resumen_de_Cuenta_Corriente_Detalle_ampliado_registro_de_Comprobante_Factura_de_Venta_FAN_Front_Telefonico(
	...
	public void TS135428_CRM_Movil_REPRO_Resumen_de_Cuenta_Corriente_Visualizacion_del_Resumen_de_Cuenta_Corriente_a_nivel_de_cuenta_de_Facturacion_FAN_Front_Telefonico(
			String sDNI, String sLinea, String sNombre, String sCuenta, String sMovil) {
		imagen = "TS135428";
		String cuenta = null;
		driver.switchTo().frame(cambioFrame(driver, By.id("SearchClientDocumentType")));
		...
		for (WebElement x : lis) {
			if (x.findElement(By.className("slds-text-body_regular")).getText().toLowerCase()
					.contains("resumen de cuenta corriente")) {
				x.click();
				break;
			}
		}
	...
	@Test(groups = { "GestionesPerfilTelefonico", "ResumenDeCuenta", "Ciclo4" }, dataProvider = "CuentaVista360")
	public void TS135429_CRM_Movil_REPRO_Resumen_de_Cuenta_Corriente_Visualizacion_del_Resumen_de_Cuenta_Corriente_a_nivel_de_cuenta_de_Facturacion_Detalle_ampliado_FAN_Front_Telefonico(
			String sDNI, String sLinea, String sNombre, String sCuenta, String sMovil) {
		imagen = "TS135429";
		String cuenta = null;
		driver.switchTo().frame(cambioFrame(driver, By.id("SearchClientDocumentType")));
		...
		System.out.println("El Resumen de Cuenta Corresponde a la cuenta: " + cuenta);
		Assert.assertTrue(cuenta.equalsIgnoreCase(sCuenta));
		WebElement detalleFactu = driver
	...
	@Test(groups = { "GestionesPerfilTelefonico", "ResumenDeCuenta", "Ciclo4" }, dataProvider = "CuentaVista360")
	public void TS135430_CRM_Movil_REPRO_Resumen_de_Cuenta_Corriente_Visualizacion_del_Resumen_de_Cuenta_Corriente_a_nivel_de_cuenta_de_Facturacion_Descarga_FAN_Front_Telefonico(
			String sDNI, String sLinea, String sNombre, String sCuenta, String sMovil) {
		imagen = "TS135430";
		String cuenta = null;
		driver.switchTo().frame(cambioFrame(driver, By.id("SearchClientDocumentType")));
	...
	@Test(groups = { "GestionesPerfilTelefonico", "ResumenDeCuenta", "Ciclo4" }, dataProvider = "CuentaVista360")
	public void TS135431_CRM_Movil_REPRO_Resumen_de_Cuenta_Corriente_Visualizacion_del_Resumen_de_Cuenta_Corriente_a_nivel_de_cuenta_de_Facturacion_Impresion_FAN_Front_Telefonico(
			String sDNI, String sLinea, String sNombre, String sCuenta, String sMovil) {
		imagen = "TS135431";
		String cuenta = null;
		driver.switchTo().frame(cambioFrame(driver, By.id("SearchClientDocumentType")));
	...
	@Test(groups = { "GestionesPerfilTelefonico", "ResumenDeCuenta", "Ciclo4" }, dataProvider = "CuentaVista360")
	public void TS135433_CRM_Movil_REPRO_Resumen_de_Cuenta_Corriente_Validaciones_de_logica_de_filtros_Fecha_FAN_Front_Telefonico(
			String sDNI, String sLinea, String sNombre, String sCuenta, String sMovil) {
		imagen = "TS135433";
		String cuenta = null;
		driver.switchTo().frame(cambioFrame(driver, By.id("SearchClientDocumentType")));
		...
		driver.findElement(By.cssSelector(
				".slds-button.slds-button--brand.filterNegotiations.slds-p-horizontal--x-large.slds-p-vertical--x-small.secondaryFont"))
				.click();
		WebElement Comprobantes = driver.findElement(By.xpath(
				"//*[@class='slds-text-heading--large slds-size--1-of-1 slds-medium-size--1-of-1 slds-large-size--1-of-1 slds-m-bottom--small'] //b[contains(text(), 'Comprobantes')]"));
		Assert.assertTrue(Comprobantes.isDisplayed());
		((JavascriptExecutor) driver).executeScript("window.scrollTo(0," + driver
				.findElements(By.cssSelector(
						".slds-size--1-of-1.slds-medium-size--1-of-1.slds-large-size--1-of-1.slds-m-top--x-large"))
				.get(1).getLocation().y + " )");
		WebElement pagos = driver.findElement(By.xpath(
				"//*[@class='slds-text-heading--large slds-size--1-of-1 slds-medium-size--1-of-1 slds-large-size--1-of-1 slds-m-bottom--small'] //b[contains(text(), 'Pagos')]"));
		Assert.assertTrue(pagos.isDisplayed());
	}

	@Test(groups = { "GestionesPerfilOficina", "ResumenDeCuenta", "Ciclo4" }, dataProvider = "CuentaVista360")
	public void TS135438_CRM_Movil_REPRO_Resumen_de_Cuenta_Corriente_Detalle_ampliado_registro_de_Comprobante_Nota_de_Credito_Debito_FAN_Front_OOCC(
			String sDNI, String sLinea, String sNombre, String sCuenta, String sMovil) {
		imagen = "TS135438";
		String cuenta = null;
		driver.switchTo().frame(cambioFrame(driver, By.id("SearchClientDocumentType")));
	...
	@Test(groups = { "GestionesPerfilTelefonico", "DiagnosticoInconvenientes", "Ciclo 3",
			"E2E" }, priority = 1, dataProvider = "Diagnostico")
	public void TS119198_CRM_Movil_PRE_Diagnostico_de_Voz_Valida_Red_y_Navegacion_Motivo_de_contacto_No_puedo_recibir_llamadas_Conciliacion_Exitosa(
			String sDNI, String sLinea) {
		imagen = "TS119198";
		detalles = null;
		detalles = imagen + " -Diagnostico Inconveniente - DNI: " + sDNI;
	...
	@Test(groups = { "GestionesPerfilTelefonico", "DiagnosticoInconvenientes", "Ciclo 3",
			"E2E" }, priority = 1, dataProvider = "Diagnostico")
	public void TS119231_CRM_Movil_PRE_Diagnostico_de_Voz_Valida_Red_y_Navegacion_Motivo_de_contacto_No_puedo_realizar_ni_recibir_llamadas_Sin_Locacion_Equipo_sin_senal(
			String sDNI, String sLinea) {
		imagen = "TS119231";
		detalles = null;
		detalles = imagen + " -Diagnostico Inconveniente - DNI: " + sDNI;
		...
		WebElement caso = driver.findElement(By.id("CoverageOkNetMessage")).findElement(By.tagName("div"))
				.findElement(By.tagName("p")).findElements(By.tagName("p")).get(1).findElement(By.tagName("span"))
				.findElement(By.tagName("strong"));
		System.out.println(caso.getText());
		// page.seleccionarPreguntaFinal("No");
		// buscarYClick(driver.findElements(By.id("DeregisterSpeech_nextBtn")),
		// "equals", "continuar");
		...
		// buscarYClick(driver.findElements(By.id("HlrDeregister_nextBtn")), "equals",
		// "continuar");
		// sleep(45000);
		// driver.switchTo().frame(accPage.getFrameForElement(driver,
		// By.id("IncorrectCategoriesMessage")));
		// WebElement caso =
		// driver.findElement(By.id("IncorrectCategoriesMessage")).findElement(By.tagName("div")).findElement(By.tagName("p")).findElements(By.tagName("p")).get(1).findElement(By.tagName("span")).findElement(By.tagName("strong"));
		// System.out.println(caso.getText());
		String Ncaso = caso.getText();
		// System.out.println("El numero de caso es: "+Ncaso);
		// driver.switchTo().defaultContent();
	...
	@Test(groups = { "GestionesPerfilTelefonico", "Diagnostico/Inconvenientes" }, dataProvider = "Diagnostico")
	public void TS119271_CRM_Movil_PRE_Diagnostico_de_Datos_Valida_Red_y_Navegacion_Motivo_de_contacto_No_puedo_Navegar_SIN_SEnAL_NO_BAM(
			String sDNI, String sLinea) throws InterruptedException {
		imagen = "TS119271";
		detalles = null;
	...
	@Test(groups = { "GestionesPerfilTelefonico", "Diagnostico/Inconvenientes" }, dataProvider = "Diagnostico")
	public void TS119171_CRM_Movil_PRE_Diagnostico_de_Voz_Valida_Red_y_Navegacion_Motivo_de_contacto_No_puedo_realizar_llamadas_Conciliacion_Exitosa(
			String sDNI, String sLinea) throws InterruptedException {
		imagen = "TS119171";
		detalles = null;
		detalles = imagen + " -Diagnostico - DNI: " + sDNI;
	...
	@Test(groups = { "GestionesPerfilTelefonico", "Solicitud De Reintegro", "E2E",
			"Ciclo4" }, dataProvider = "ConsultaSaldo")
	public void TS112598_CRM_Movil_PRE_Pago_con_Tarjeta_de_debito_Reintegro_con_Efectivo_1000(String sDNI) {
		...
		for (WebElement x : tabla) {
			if (x.getText().toLowerCase().contains("tarjeta de d\u00e9bito")
					&& x.getText().toLowerCase().contains("1000")) {
	...
	@Test(groups = { "GestionesPerfilTelefonico", "Diagnostico/Inconvenientes" }, dataProvider = "Diagnostico")
	public void TS119269_CRM_Movil_PRE_Diagnostico_de_Datos_Valida_Red_y_Navegacion_Motivo_de_contacto_No_puedo_Navegar_con_rellamado_NO_BAM(
			String sDNI, String sLinea) throws InterruptedException {
		imagen = "TS119269";
		detalles = null;
		detalles = imagen + " -Diagnostico - DNI: " + sDNI;
		...
		sleep(8000);
		String caso = driver.findElement(By.xpath("//*[@id=\"MobileConfigSendingMessage\"]/div/p/h1/span/strong"))
				.getText();
		System.out.println(caso);
		driver.switchTo().defaultContent();
		tech.buscarCaso(caso);
