...
public class GestionesPerfilOficina extends TestBase {
	...
	public void init() throws IOException, AWTException {
		...
		try {
			...
			/*
			 * sleep(3000); waitForClickeable(driver,By.id("tabBar"));
		...
		// Assert.assertTrue(cCBSM.Imprimir(driver,"20181227000000108255",
		// "1000000026310001"));
	...
	public void setup() throws Exception {
		...
		driver.switchTo().frame(accountPage.getFrameForElement(driver,
				By.cssSelector(".hasMotif.homeTab.homepage.ext-webkit.ext-chrome.sfdcBody.brandQuaternaryBgr")));
		...
		for (WebElement frame : frames) {
			try {
				...
				driver.findElement(By.cssSelector(".slds-grid.slds-m-bottom_small.slds-wrap.cards-container"))
						.getText(); // each element is in the same iframe.
				// System.out.println(index); //prints the used index.

				driver.findElement(By.cssSelector(".slds-grid.slds-m-bottom_small.slds-wrap.cards-container"))
						.isDisplayed(); // each element is in the same iframe.
				// System.out.println(index); //prints the used index.

				driver.switchTo().frame(accountPage.getFrameForElement(driver, By
						.cssSelector(".hasMotif.homeTab.homepage.ext-webkit.ext-chrome.sfdcBody.brandQuaternaryBgr")));
				enc = true;
				break;
	...
	public void TS100602_CRM_Movil_REPRO_FF_Alta_Presencial(String sDNI, String sLinea, String sNumeroVOZ,
			String sNumeroSMS) {
		imagen = "TS100602";
		detalles = null;
		...
		String accid = driver.findElement(By.cssSelector(".searchClient-body.slds-hint-parent.ng-scope"))
	...
	@Test(groups = { "GestionesPerfilOficina", "NumerosAmigos", "E2E",
			"Ciclo1" }, dataProvider = "NumerosAmigosModificacion")
	public void TS100604_CRM_Movil_REPRO_FF_Modificacion_Presencial(String sDNI, String sLinea, String sNumeroVOZ,
			String sNumeroSMS) {
		imagen = "TS100604";
		detalles = null;
		detalles = imagen + "-Numeros Amigos-DNI:" + sDNI;
		...
		CBS cCBS = new CBS();
		CBS_Mattu cCBSM = new CBS_Mattu();
		String sMainBalance = cCBS.ObtenerValorResponse(cCBSM.Servicio_queryLiteBySubscriber(sLinea),
				"bcs:MainBalance");
		...
		cCC.seleccionarCardPornumeroLinea(sLinea, driver);
		cCC.irAGestionEnCard("N\u00fameros Gratis");
		String uMainBalance = cCBS.ObtenerValorResponse(cCBSM.Servicio_queryLiteBySubscriber(sLinea),
				"bcs:MainBalance");
	...
	public void TS134318_CRM_Movil_REPRO_Recargas_Presencial_Efectivo_Ofcom(String cDNI, String cMonto, String cLinea)
		...
		CBS_Mattu cCBSM = new CBS_Mattu();
		// String sMainBalance =
		// cCBS.ObtenerValorResponse(cCBSM.Servicio_queryLiteBySubscriber(cLinea),
		// "bcs:MainBalance");
		// Integer iMainBalance = Integer.parseInt(sMainBalance.substring(0,
		// (sMainBalance.length()) - 1));
		if (cMonto.length() >= 4) {
		...
		Assert.assertTrue(msj.toLowerCase().contains(
				"se ha enviado correctamente la factura a huawei. dirigirse a caja para realizar el pago de la misma"));
		...
		sleep(10000);
		driver.switchTo().frame(cambioFrame(driver,
				By.cssSelector(".hasMotif.orderTab.detailPage.ext-webkit.ext-chrome.sfdcBody.brandQuaternaryBgr")));
		WebElement tabla = driver.findElement(By.id("ep")).findElements(By.tagName("table")).get(1);
		String datos = tabla.findElements(By.tagName("tr")).get(4).findElements(By.tagName("td")).get(1).getText();
		Assert.assertTrue(datos.equalsIgnoreCase("activada") || datos.equalsIgnoreCase("activated"));
		String uMainBalance = cCBS.ObtenerValorResponse(cCBSM.Servicio_queryLiteBySubscriber(cLinea),
				"bcs:MainBalance");
	...
	public void TS134330_CRM_Movil_REPRO_Recargas_Presencial_TC_Ofcom_Financiacion(String cDNI, String cMonto,
			String cLinea, String cBanco, String cTarjeta, String cNumTarjeta, String cVenceMes, String cVenceAno,
			String cCodSeg, String cTipoDNI, String cDNITarjeta, String cTitular, String cPromo, String cCuotas)
			throws AWTException, KeyManagementException, NoSuchAlgorithmException {
		imagen = "TS134330";
		detalles = null;
		detalles = imagen + "-Recarga - DNI:" + cDNI;
		CBS cCBS = new CBS();
		CBS_Mattu cCBSM = new CBS_Mattu();
		String sMainBalance = cCBS.ObtenerValorResponse(cCBSM.Servicio_queryLiteBySubscriber(cLinea),
				"bcs:MainBalance");
		Integer iMainBalance = Integer.parseInt(sMainBalance.substring(0, (sMainBalance.length()) - 1));
		...
		String sOrden = cc.obtenerOrden3(driver);
		// driver.switchTo().frame(cambioFrame(driver,
		// By.id("InvoicePreview_nextBtn")));
		driver.findElement(By.xpath("//*[@id=\"InvoicePreview_nextBtn\"]")).click();
		sleep(20000);
		buscarYClick(driver.findElements(By.cssSelector(".slds-form-element__label.ng-binding")), "equals",
				"tarjeta de credito");
		sleep(20000);
	...
	public void TS134338_CRM_Movil_PRE_Baja_de_Servicio_sin_costo_DDI_con_Roaming_Internacional_Presencial(String sDNI,
			String sLinea) throws AWTException {
		imagen = "TS134338";
		detalles = null;
		detalles = imagen + "-BajaServicio-DNI:" + sDNI;
		GestionFlow gGF = new GestionFlow();
		// Assert.assertTrue(gGF.FlowConsultaServicioActivo(driver, sLinea, "Discado
		// Directo Internacional con Roaming Int."));
		...
		cc.closerightpanel();
		driver.switchTo().defaultContent();
		driver.switchTo().frame(cambioFrameByID.getFrameForElement(driver,
				By.cssSelector(".slds-text-body--small.slds-page-header__info.taDevider")));
		String sOrder = driver.findElement(By.cssSelector(".slds-text-body--small.slds-page-header__info.taDevider"))
				.getText();
		...
		Assert.assertTrue(wMessageBox.getText().toLowerCase()
				.contains("la orden " + sOrder + " se realiz\u00f3 con \u00e9xito!".toLowerCase()));
		sleep(15000);
	...
	public void TS134355_CRM_Movil_PRE_Alta_Servicio_sin_costo_DDI_con_Roaming_Internacional_Presencial(String sDNI,
			String sLinea) throws AWTException {
		imagen = "TS134355";
		detalles = null;
		...
		GestionFlow gGF = new GestionFlow();
		Assert.assertTrue(
				gGF.FlowConsultaServicioInactivo(driver, sLinea, "Discado Directo Internacional con Roaming Int."));
		BasePage cambioFrameByID = new BasePage();
		sleep(30000);
		driver.switchTo().frame(cambioFrameByID.getFrameForElement(driver, By.id("SearchClientDocumentType")));
		sleep(1000);
		...
		driver.switchTo().frame(cambioFrame(driver, By.id("tab-default-1")));
		ppt = new PagePerfilTelefonico(driver);
		// Dada la estructura de la funcion es lo mismo porque al dar de baja uno, da de
		// alta el otro para poder continuar
	...
	public void TS_85094_CRM_Movil_REPRO_Nominatividad_Cliente_Nuevo_Presencial_DOC_OfCom(String sLinea, String sDni,
			String sNombre, String sApellido, String sSexo, String sFnac, String sEmail, String sProvincia,
			String sLocalidad, String sCalle, String sNumCa, String sCP) {
		...
		sleep(3000);
		List<WebElement> Lineas = driver.findElement(By.id("tab-scoped-1")).findElement(By.tagName("tbody"))
				.findElements(By.tagName("tr"));
		for (WebElement UnaL : Lineas) {
			if (UnaL.getText().toLowerCase().contains("plan con tarjeta repro")
					|| UnaL.getText().toLowerCase().contains("plan prepago nacional")) {
		...
		try {
			contact.ingresarMail(sEmail, "si");
	...
	public void gestionSuspension(String cDNI, String cLinea, String cProvincia, String cCiudad, String cPartido) {
		...
		buscarYClick(driver.findElements(By.cssSelector(".slds-form-element__label.ng-binding.ng-scope")), "contains",
				"suspensi\u00f3n");
		...
		sleep(10000);
		buscarYClick(driver.findElements(By.cssSelector(".slds-form-element__label.ng-binding")), "contains",
				"l\u00ednea: " + cLinea);
		...
		sleep(15000);
		buscarYClick(driver.findElements(By.cssSelector(".slds-button.slds-button--neutral.ng-binding.ng-scope")),
				"contains", "continue");
		sleep(15000);
		boolean a = false;
	...
	@Test(groups = { "ProblemasConRecargas", "GestionesPerfilOficina", "E2E",
			"Ciclo3" }, dataProvider = "CuentaProblemaRecarga")
	...
	@Test(groups = { "ProblemasConRecargas", "GestionesPerfilOficina", "E2E",
			"Ciclo3" }, dataProvider = "CuentaProblemaRecarga") // Error al intentar impactar la recarga
	public void poblemaRecargaCredito(String cDNI, String sLinea) {
		...
		sleep(8000);
		driver.switchTo().frame(cambioFrame(driver, By.id("RefillMethods_nextBtn")));
		buscarYClick(driver.findElements(By.cssSelector(".imgItemContainer.ng-scope")), "contains",
				"tarjeta de cr\u00e9dito");
		driver.findElement(By.id("RefillMethods_nextBtn")).click();
		sleep(8000);
		buscarYClick(driver.findElements(By.cssSelector(".slds-form-element__label.ng-binding.ng-scope")), "contains",
	...
	public void TS103596_CRM_Movil_REPRO_Ajuste_General_FAN_Front_OOCC(String sDNI, String sLinea) {
		...
		buscarYClick(driver.findElements(By.cssSelector(".slds-form-element__label.ng-binding.ng-scope")), "equals",
				"si");
		...
		if (TestBase.urlAmbiente.contains("sit")) {
			...
			detalles += " - Orden: " + orden;
			sOrders.add("Inconvenientes con cargos tasados y facturados, orden numero: " + orden
					+ " con numero de DNI: " + sDNI);
			Assert.assertTrue(cc.verificarOrden(orden));
		} else {
			String orden = driver.findElement(By.xpath("//*[@id=\"txtSuccessConfirmation\"]/div"))
					.findElement(By.tagName("strong")).getText();
			detalles += " - Orden: " + orden;
			sOrders.add("Inconvenientes con cargos tasados y facturados, numero de orden: " + orden
					+ " de cuenta con DNI: " + sDNI);
			Assert.assertTrue(cc.verificarOrdenYGestion("Inconvenientes con cargos tasados y facturados"));
		}
	}

	@Test(groups = { "GestionesPerfilOficina", "ModificarDatos", "E2E", "Ciclo3" }) // No se puede modificar el DNI 2
																					// veces en un mes
	public void GestionActualizacionDatos() {
		...
		/*
		 * driver.findElement(By.id("ClientInformation_nextBtn")).click(); sleep(10000);
		 * List <WebElement> element =
		 * driver.findElements(By.className("ta-care-omniscript-done")); for (WebElement
		 * x : element) { if (x.getText().toLowerCase().
		 * contains("se realizaron correctamente las modificaciones")) { gest = true; }
		 * } Assert.assertTrue(gest);
		 */
	}

	@Test(groups = { "GestionesPerfilOficina", "ProblemasConRecargas", "E2E",
			"Ciclo3" }, dataProvider = "ProblemaRecargaPrepaga") // Se necesitan nuevos numeros de tarjeta, solo se
																	// pueden usar 1 vez
	...
	public void TS98438_CRM_Movil_REPRO_Suspension_por_Siniestro_Hurto_Linea_Titular_Presencial(String cDNI,
			String cLinea, String cProvincia, String cCiudad, String cPartido) {
		imagen = "TS98438";
		detalles = null;
	...
	public void TS135707_CRM_Movil_PRE_Ajuste_Nota_de_Debito_FAN_Front_OOCC_Bariloche(String sDNI, String sLinea) {
		...
		driver.findElement(By.id("Step-Summary_nextBtn")).click();
		sleep(10000);
		String nroCaso = driver.findElement(By.xpath("//*[@id=\"txtSuccessConfirmation\"]/div"))
				.findElement(By.tagName("strong")).getText();
	...
	public void TS98590_CRM_Movil_REPRO_Rehabilitacion_por_Siniestro_Presencial_Robo_Linea(String sDNI, String sLinea) {
		...
		buscarYClick(driver.findElements(By.cssSelector(
				".ta-radioBtnContainer.taBorderOverlay.slds-grid.slds-grid--align-center.slds-grid--vertical-align-center")),
				"contains", "validaci\u00f3n por documento de identidad");
	...
	// @Test (groups = {"GestionesPerfilOficina", "Ajustes", "E2E"}, dataProvider =
	// "CuentaAjustesPRE") //Diferido
	...
	public void TS129317_CRM_Movil_REPRO_Ajuste_RAV_Unidades_Libres_a_Pesos_General_FAN_Front_OOCC(String sDNI,
		...
		driver.findElement(By.id("Step-AjusteNivelLinea_nextBtn")).click();
		sleep(7000);
		WebElement fact = driver.findElement(By.cssSelector(".slds-card.ng-scope"))
				.findElements(By.cssSelector(".slds-card__header.slds-grid")).get(1);
	...
	@Test(groups = { "GestionesPerfilOficina", "RenovacionDeCuota", "E2E",
			"Ciclo1" }, dataProvider = "RenovacionCuotaSinSaldo")
	public void TS135396_CRM_Movil_REPRO_Renovacion_de_cuota_Presencial_Internet_50_MB_Dia_Efectivo_sin_Credito(
			String sDNI, String sLinea) throws AWTException {
		imagen = "TS135396";
		// Check all
		detalles = null;
		...
		List<WebElement> elementos = driver
				.findElement(By.cssSelector(".table.slds-table.slds-table--bordered.slds-table--cell-buffer"))
		...
		sleep(10000);
		List<WebElement> pago = driver.findElement(By.id("PaymentTypeRadio|0"))
				.findElements(By.cssSelector(".slds-radio.ng-scope"));
		...
		sleep(30000);
		String check = driver.findElement(By.id("GeneralMessageDesing")).getText();
		// Assert.assertTrue(msj.toLowerCase().contains("se ha enviado correctamente la
		// factura a huawei. dirigirse a caja para realizar el pago de la misma"));
		Assert.assertTrue(check.toLowerCase().contains("la orden se realiz\u00f3 con \u00e9xito"));
	...
	public void TS112598_CRM_Movil_PRE_Pago_con_Tarjeta_de_debito_Reintegro_con_Efectivo_1000(String cDNI) {
		...
		buscarYClick(driver.findElements(By.className("slds-text-body_regular")), "contains",
	...
	@Test(groups = { "ProblemasConRecargas", "GestionesPerfilOficina", "E2E",
			"Ciclo3" }, dataProvider = "CuentaProblemaRecargaAYD") // Lote: 11120000001688 PIN: 02222
	public void TS135714_CRM_Movil_PRE_Problemas_con_Recarga_Telefonico_Tarjeta_Scratch_Caso_Nuevo_Tarjeta_Activa_y_Disponible(
			String cDNI, String sLinea, String cSerie, String cPIN) {
		CBS_Mattu verifM = new CBS_Mattu();
		CBS verif = new CBS();
		String saldo = verif.ObtenerValorResponse(verifM.Servicio_queryLiteBySubscriber(sLinea), "bcs:MainBalance");
		Integer saldo1 = Integer.parseInt(saldo.substring(0, 5));
	...
	@Test(groups = { "ProblemasConRecargas", "GestionesPerfilOficina", "E2E",
			"Ciclo3" }, dataProvider = "CuentaProblemaRecargaQuemada")
	public void TS104347_CRM_Movil_REPRO_Problemas_con_Recarga_Presencial_Tarjeta_Scratch_Caso_Nuevo_Quemada(
			String cDNI, String sLinea, String cSerie, String cPIN) {
		CBS_Mattu verifM = new CBS_Mattu();
		CBS verif = new CBS();
		String saldo = verif.ObtenerValorResponse(verifM.Servicio_queryLiteBySubscriber(sLinea), "bcs:MainBalance");
		...
		driver.switchTo().frame(
				cambioFrame(driver, By.cssSelector(".slds-icon.slds-icon--large.ta-care-omniscript-error-icon")));
		boolean b = false;
	...
	@Test(groups = { "GestionesPerfilOficina", "TriviasYSuscripciones", "E2E",
			"Ciclo3" }, dataProvider = "CuentaTriviasYSuscripciones")
	public void TS119032_CRM_Movil_REPRO_Suscripciones_Baja_de_suscripciones_sin_BlackList_Presencial(String cDNI,
		...
		driver.findElement(By.cssSelector(".addedValueServices-row.ng-pristine.ng-untouched.ng-valid.ng-empty"))
				.findElement(By.className("slds-checkbox")).click();
		...
		try {
			driver.switchTo().frame(
					cambioFrame(driver, By.cssSelector(".slds-button.slds-button--neutral.ng-binding.ng-scope")));
		...
		sleep(10000);
		List<WebElement> msj = driver.findElements(By.cssSelector(
				".slds-form-element.vlc-flex.vlc-slds-text-block.vlc-slds-rte.ng-pristine.ng-valid.ng-scope"));
		for (WebElement x : msj) {
	...
	public void TS110893_CRM_Movil_REPRO_Suscripciones_Baja_de_una_suscripcion_con_BlackList_con_ajuste_Presencial(
		...
		buscarYClick(blackList.findElements(By.cssSelector(".slds-form-element__label.ng-binding.ng-scope")), "equals",
				"s\u00ed");
		driver.findElement(By.id("UnsubscriptionOptions_nextBtn")).click();
		sleep(10000);
		try {
	...
	public void TS134320_CRM_Movil_REPRO_Recargas_Presencial_TD_Ofcom(String sDNI, String sMonto, String sLinea,
			String sBanco, String sTarjeta, String sNumTarjeta, String sVenceMes, String sVenceAno, String sCodSeg,
			String sTipoDNI, String sDNITarjeta, String sTitular) throws AWTException {
		if (sMonto.length() >= 4) {
		...
		driver.switchTo().frame(cambioFrame(driver, By.id("SearchClientDocumentType")));
		sb.BuscarCuenta("DNI", sDNI);
		String sAccid = driver.findElement(By.cssSelector(".searchClient-body.slds-hint-parent.ng-scope"))
				.findElements(By.tagName("td")).get(5).getText();
		...
		Assert.assertTrue(
				cInvoSer.PagoEnCaja("1006", sAccid, "4001", sOrden.split("-")[2], sOrden.split("-")[1], driver));
		sleep(5000);
		driver.navigate().refresh();
		sleep(10000);
		String uMainBalance = cCBS.ObtenerValorResponse(cCBSM.Servicio_queryLiteBySubscriber(sLinea),
	...
	public void Venta_de_Pack_1_GB_x_1_dia_whatsapp_gratis_Factura_de_Venta_TC_OffCom(String sDNI, String sLinea,
			String sPackOfCom, String cBanco, String cTarjeta, String cPromo, String cCuotas)
			throws AWTException, KeyManagementException, NoSuchAlgorithmException {
	...
	// ================ ESTE VA 1 ============
	@Test(groups = { "GestionesPerfilOficina", "CambioSimCard",
			"Ciclo3" }, priority = 1, dataProvider = "CambioSimCardOficina")
	...
	@Test(groups = { "GestionesPerfilOficina", "RenovacionDeCuota", "E2E",
			"Ciclo1" }, dataProvider = "RenovacionCuotaSinSaldoConTC")
	public void TS135397_CRM_Movil_REPRO_Renovacion_de_cuota_Presencial_Internet_50_MB_Dia_TC_sin_Credito(String sDNI,
			String sLinea, String sBanco, String sTarjeta, String sPromo, String sCuota, String sNumTarjeta,
			String sVenceMes, String sVenceAno, String sCodSeg, String sTipoDNI, String sDNITarjeta, String sTitular)
			throws AWTException, KeyManagementException, NoSuchAlgorithmException {
		imagen = "TS135397";
		// Check all
		detalles = "Renocavion de cuota: " + imagen + "DNI: " + sDNI + "Linea: " + sLinea;
	...
	@Test(groups = { "GestionesPerfilOficina", "AnulacionDeVenta", "E2E",
			"Ciclo4" }, dataProvider = "CuentaAnulacionDeVenta")
	public void Anulacion_De_Venta(String sDNI) {
		...
		sleep(15000);
		driver.switchTo().frame(
				cambioFrame(driver, By.cssSelector(".slds-select.ng-pristine.ng-untouched.ng-valid.ng-not-empty")));
		buscarYClick(driver.findElements(By.cssSelector(".slds-button.slds-button--neutral")), "equals",
				"anulaci\u00f3n de venta");
		sleep(10000);
		...
		String gestion = driver.findElement(By.xpath("//*[@id=\"ep\"]/div[2]/div[2]/table"))
				.findElements(By.tagName("tr")).get(4).getText();
		Assert.assertTrue(
				gestion.contains("Estado") && (gestion.contains("Cancelada") || gestion.contains("Cancelled")));
	}
	...
	public void TS135346_Historial_de_Recargas_Consultar_detalle_de_Recargas_por_Canal_TODOS_Fan_FRONT_OOCC(
		...
		if (driver.findElement(By.cssSelector(
				".slds-button.slds-button--brand.filterNegotiations.slds-p-horizontal--x-large.slds-p-vertical--x-small"))
				.isDisplayed()) {
	...
	public void TS134373_CRM_Movil_Prepago_Vista_360_Consulta_de_Saldo_Verificar_credito_prepago_de_la_linea_FAN_Front_OOCC(
			String sDNI, String sLinea, String sAccountKey) {
		imagen = "TS134373";
		detalles = null;
	...
	@Test(groups = { "GestionesPerfilOficina", "ConsultaDeSaldo", "Ciclo1" }, dataProvider = "ConsultaSaldo")
	public void TS134376_CRM_Movil_Prepago_Vista_360_Consulta_de_Saldo_Verificar_saldo_del_cliente_FAN_Front_OOCC(
			String sDNI, String sLinea, String sAccountKey) {
		imagen = "TS134376";
		detalles = null;
		detalles = imagen + "- Consulta de Saldo - DNI:" + sDNI;
	...
	public void TS134783_CRM_Movil_Prepago_Vista_360_Detalle_de_consumo_Consulta_detalle_de_consumo_Datos_FAN_Front_OOCC_134783(
			String sDNI, String sLinea) {
		CustomerCare cCC = new CustomerCare(driver);
		imagen = "TS134783";
		detalles = null;
		...
		List<WebElement> serv = driver.findElement(By.cssSelector(".slds-dropdown__list.slds-dropdown--length-5"))
		...
		WebElement ConsumoDatos = driver.findElement(By.className("summary-container"))
				.findElements(By.className("unit-div")).get(0);
		;
		System.out.println(ConsumoDatos.getText());
		Assert.assertTrue(ConsumoDatos.isDisplayed());
	}

	@Test(groups = { "GestionesPerfilOficina", "DetalleDeConsumo",
			"Ciclo2" }, dataProvider = "CuentaTriviasYSuscripciones")
	public void TS134782_CRM_Movil_Prepago_Vista_360_Detalle_de_consumo_Consulta_detalle_de_consumo_SMS_FAN_Front_OOCC_134782(
			String sDNI, String sLinea) {
		imagen = "TS134782";
		detalles = null;
	...
	@Test(groups = { "GestionesPerfilOficina", "DetalleDeConsumo", "Ciclo2" }, dataProvider = "CuentaProblemaRecarga")
	public void TS134784_CRM_Movil_Prepago_Vista_360_Detalle_de_consumo_Consulta_detalle_de_consumo_Voz_FAN_Front_OOCC(
			String sDNI, String sLinea) {
		imagen = "TS134784";
		detalles = null;
	...
	@Test(groups = { "GestionesPerfilOficina", "DetalleDeConsumo", "Ciclo2" }, dataProvider = "CuentaProblemaRecarga")
	public void TS134785_CRM_Movil_Prepago_Vista_360_Detalle_de_consumo_Consulta_detalle_de_Otros_consumos_FAN_Front_OOCC_134785(
			String sDNI, String sLinea) {
		CustomerCare cCC = new CustomerCare(driver);
		imagen = "TS134785";
		detalles = null;
		...
		driver.switchTo().frame(cambioFrame(driver, By.cssSelector(
				".slds-grid.slds-wrap.slds-grid--pull-padded.slds-m-around--medium.slds-p-around--medium.negotationsfilter")));
		driver.findElements(By.cssSelector(".slds-picklist.slds-dropdown-trigger.slds-dropdown-trigger--click")).get(1)
				.findElement(By.cssSelector(".slds-button.slds-input__icon.slds-text-color--default")).click();
		// WebElement periodosDeConsulta = driver.findElement(By.cssSelector(
		// "[class='slds-grid slds-wrap slds-grid--pull-padded slds-m-around--medium
		// slds-p-around--medium negotationsfilter'] [class='slds-p-horizontal--small
		// slds-size--1-of-1 slds-medium-size--2-of-8 slds-large-size--2-of-8']
		// [class='slds-dropdown slds-dropdown--left'] [class='slds-dropdown__list
		// slds-dropdown--length-3']"));
		...
		List<WebElement> filas = driver.findElements(By.cssSelector(
				"[class='slds-size--1-of-1 slds-medium-size--1-of-1 slds-large-size--1-of-1 slds-m-top--medium'] tbody tr"));
		filas.get(0).click();
		// filas despues de hacer click en el consumo
		filas = driver.findElements(By.cssSelector(
				"[class='slds-size--1-of-1 slds-medium-size--1-of-1 slds-large-size--1-of-1 slds-m-top--medium'] tbody tr"));
		List<WebElement> detalles = filas.get(1).findElements(By.cssSelector(".slds-text-heading--label"));
		List<String> detallesReferencia = new ArrayList<String>(
				Arrays.asList("FECHA DE INICIO", "FECHA DE FIN", "PRODUCTO", "IMPORTE", "ORIGEN/DESTINO"));
		...
		// ".slds-grid.slds-wrap.slds-grid--pull-padded.slds-m-around--medium.slds-p-around--medium.negotationsfilter")));
		// driver.findElement(By.id("text-input-01")).click();
		// List<WebElement> serv =
		// driver.findElement(By.cssSelector(".slds-dropdown__list.slds-dropdown--length-5"))
		// .findElements(By.tagName("li"));
		// for (WebElement s : serv) {
		// if (s.getText().contains(sLinea)) {
		// s.click();
		...
		// }
		// driver.findElement(By.id("text-input-02")).click();
		// List<WebElement> periodo =
		// driver.findElement(By.id("option-list-01")).findElements(By.tagName("li"));
		// periodo.get(1).click();
		// buscarYClick(driver.findElements(By.cssSelector(".slds-button.slds-button--brand")),
		// "equals", "consultar");
		// sleep(5000);
		// Boolean a = false;
		// driver.switchTo().frame(cambioFrame(driver, By.className("unit-div")));
	...
	public void TS134470_CRM_Movil_Prepago_Historial_De_Recargas_SOS_S440_FAN_Front_OOCC(String cDNI, String cLinea) {
		...
		for (WebElement UnH : historiales) {
			...
			if (UnH.findElement(By.cssSelector(".slds-card__header.slds-grid")).getText()
					.equals("Historial de recargas S.O.S")) {
				enc = true;
				driver.findElements(By.cssSelector(".slds-button.slds-button_brand")).get(1).click();
				sleep(5000);
				driver.switchTo().frame(cambioFrame(driver, By.cssSelector(
						".slds-text-heading--large.slds-size--1-of-1.slds-medium-size--1-of-1.slds-large-size--1-of-1.slds-p-around--medium")));
				driver.findElement(By.cssSelector(
						".slds-button.slds-button--brand.filterNegotiations.slds-p-horizontal--x-large.slds-p-vertical--x-small"))
						.click();
				sleep(5000);
	...
	public void TS135496_CRM_Movil_REPRO_Busqueda_DNI_Numero_de_Documento(String sDNI, String sNumeroDeCuenta,
		...
		// List<WebElement> solapas =
		// driver.findElement(By.className("slds-tabs--scoped__nav"))
		// .findElements(By.tagName("li"));

		List<WebElement> datos = driver.findElement(By.cssSelector(".searchClient-body.slds-hint-parent.ng-scope"))
				.findElements(By.cssSelector(".slds-truncate.ng-binding"));
		// System.out.println(datos.getText());
		// List<WebElement> datosList =
		// datos.findElements(By.cssSelector(".slds-truncate.ng-binding"));
	...
	public void TS135503_CRM_Movil_REPRO_Busqueda_Apellido(String sDNI, String sNumeroDeCuenta, String sNombre,
		...
		// assertTrue(solapas.get(0).findElement(By.tagName("a")).getText().equals("Clientes
		// Activos"));
	}
	...
	@Test(groups = { "GestionesPerfilOficina", "Nominacion",
			"Ciclo1" }, dataProvider = "DatosSalesNominacionExistenteOfCom")
	public void TS85097_CRM_Movil_REPRO_Nominatividad_Cliente_Existente_Presencial_DOC_OfCom(String sLinea,
			String sDni) {
		imagen = "TS85097";
		detalles = null;
	...
	public void TS130056_CRM_Movil_REPRO_Renovacion_de_cuota_Presencial_Reseteo_200_MB_por_Dia_Efectivo_con_Credito(
			String sDNI, String sLinea) throws AWTException {
		imagen = "TS130056";
		detalles = null;
		detalles = "Renocavion de cuota: " + imagen + " - DNI: " + sDNI + " - Linea: " + sLinea;
		...
		sleep(20000);
		// String msj =
		// driver.findElement(By.cssSelector(".message.description.ng-binding.ng-scope")).getText();
		// String check = driver.findElement(By.id("GeneralMessageDesing")).getText();
		// Assert.assertTrue(msj.toLowerCase().contains("se ha enviado correctamente la
		// factura a huawei. dirigirse a caja para realizar el pago de la misma"));
		// Assert.assertTrue(check.toLowerCase().contains("la orden se realiz\u00f3 con
		// \u00e9xito"));
		driver.findElement(By.id("SaleOrderMessages_nextBtn")).click();
		sleep(8000);
		String orden = cc.obtenerTNyMonto2(driver, sOrden);
	...
	@Test(groups = { "GestionesPerfilOficina", "RenovacionDeCuota", "E2E" }, dataProvider = "RenovacionCuotaConSaldo")
	public void TS130069_CRM_Movil_REPRO_Renovacion_de_cuota_Presencial_Reseteo_200_MB_por_Dia_Descuento_de_saldo_con_Credito(
			String sDNI, String sLinea) {
		imagen = "TS130069";
		detalles = null;
		detalles = "Renocavion de cuota: " + imagen + " - DNI: " + sDNI + " - Linea: " + sLinea;
	...
	@Test(groups = { "GestionesPerfilOficina", "RenovacionDeCuota", "E2E",
			"Ciclo1" }, dataProvider = "RenovacionCuotaConSaldo")
	public void TS135395_CRM_Movil_REPRO_Renovacion_de_cuota_Presencial_Internet_50_MB_Dia_Efectivo_con_Credito(
			String sDNI, String sLinea) throws AWTException {
		imagen = "TS135395";
		// Check all
		detalles = null;
	...
	public void TS135497_CRM_Movil_REPRO_Busqueda_DNI_Numero_de_Documento_no_existente(String sDNI,
			String sNumeroDeCuenta, String sNombre, String sApellido, String sLibreta, String sRazon, String sEmail) {
		imagen = "TS135497";
		detalles = null;
		detalles = imagen + "-Gestion de clientes - DNI: " + sDNI;
		driver.switchTo().frame(cambioFrame(driver, By.id("SearchClientDocumentType")));
		...
		for (WebElement x : driver.findElements(By.className("slds-form-element__control"))) {
			if (x.getText().toLowerCase().equals(
					"no hay ning\u00fan cliente con este tipo y n\u00famero de documento. busc\u00e1 con otro dato o cre\u00e1 un nuevo cliente.")) {
				a = true;
			}
		}
		Assert.assertTrue(a);
	...
	@Test(groups = { "Sales", "GestionDeClientes", "Ciclo1" }, dataProvider = "validaDocumentacion")
	public void TS135499_CRM_Movil_REPRO_Busqueda_Libreta_de_enrolamiento_Numero_de_Documento(String sDNI,
			String sNumeroDeCuenta, String sNombre, String sApellido, String sLibreta, String sRazon, String sEmail) {
		imagen = "TS135499";
		detalles = null;
	...
	@Test(groups = { "Sales", "GestionDeClientes", "Ciclo1" }, dataProvider = "invalidaDocumentacion")
	public void TS135500_CRM_Movil_REPRO_Busqueda_Libreta_dE_enrolamiento_Numero_de_Documento_no_existente(String sDNI,
			String sNumeroDeCuenta, String sNombre, String sApellido, String sLibreta, String sRazon, String sEmail) {
		imagen = "TS135500";
		detalles = null;
		detalles = imagen + "- Gestion de clientes - Libreta de enrolamiento: " + sLibreta;
		...
		for (WebElement x : driver.findElements(By.className("slds-form-element__control"))) {
			if (x.getText().toLowerCase()
					.contains("no hay ning\u00fan cliente con este tipo y n\u00famero de documento."))
				libreta = true;
		}
	...
	public void TS135501_CRM_Movil_REPRO_Busqueda_Nombre(String sDNI, String sNumeroDeCuenta, String sNombre,
		...
		// List<WebElement> activo =
		// driver.findElement(By.className("slds-tabs--scoped__nav"))
		// .findElements(By.tagName("li"));
		// assertTrue(activo.get(0).findElement(By.tagName("a")).getText().equals("Clientes
		// Activos"));
		// WebElement completeTable =
		// driver.findElement(By.cssSelector(".slds-tabs--scoped.ng-scope")).findElement(By.cssSelector(".slds-table.slds-table--bordered.slds-tree
		// slds-table--tree.table.tableCSS"));

		List<WebElement> filasDeResultados = driver.findElements(By.cssSelector(
				"[class='slds-tabs--scoped ng-scope'] [class='slds-tabs--scoped__content'] div table tbody [class='searchClient-body slds-hint-parent ng-scope']"));
		...
		// driver.findElement(By.cssSelector(".searchClient-body.slds-hint-parent.ng-scope")).findElements(By.cssSelector(".slds-truncate.ng-binding"));
		// assertTrue(datos.get(3).getText().equals(sDNI));
		assertTrue(assertCondition);
	}

	@Test(groups = { "Sales", "GestionDeClientes", "Ciclo1" }, dataProvider = "invalidaDocumentacion")
	public void TS135502_CRM_Movil_REPRO_Busqueda_Nombre_No_existente(String sDNI, String sNumeroDeCuenta,
			String sNombre, String sApellido, String sLibreta, String sRazon, String sEmail) {
		imagen = "TS135502";
		detalles = null;
		detalles = imagen + " - Gestion de clientes - Nombre: " + sNombre;
	...
	@Test(groups = { "Sales", "GestionDeClientes", "Ciclo1" }, dataProvider = "invalidaDocumentacion")
	public void TS135504_CRM_Movil_REPRO_Busqueda_Apellido_No_existente(String sDNI, String sNumeroDeCuenta,
			String sNombre, String sApellido, String sLibreta, String sRazon, String sEmail) {
		imagen = "TS135504";
		detalles = null;
	...
	@Test(groups = { "Sales", "GestionDeClientes", "Ciclo1" }, dataProvider = "invalidaDocumentacion")
	public void TS135506_CRM_Movil_REPRO_Busqueda_Razon_social_No_existente(String sDNI, String sNumeroDeCuenta,
			String sNombre, String sApellido, String sLibreta, String sRazon, String sEmail) {
		imagen = "TS135506";
		detalles = null;
		detalles = imagen + " - Gestion de clientes - Razon social: " + sRazon;
		...
		List<WebElement> vacio = driver.findElement(By.className("slds-tabs--scoped__nav"))
				.findElements(By.tagName("li"));
	...
	@Test(groups = { "Sales", "GestionDeClientes", "Ciclo1" }, dataProvider = "invalidaDocumentacion")
	public void TS135508_CRM_Movil_REPRO_Busqueda_Email_No_existente(String sDNI, String sNumeroDeCuenta,
			String sNombre, String sApellido, String sLibreta, String sRazon, String sEmail) {
		imagen = "TS135508";
		detalles = null;
		detalles = imagen + " - Gestion de clientes - Email: " + sEmail;
	...
	@Test(groups = { "Sales", "GestionDeClientes", "Ciclo1" }, dataProvider = "invalidaDocumentacion")
	public void TS135510_CRM_Movil_REPRO_Busqueda_Numero_de_Cuenta_No_existente(String sDNI, String sNumeroDeCuenta,
			String sNombre, String sApellido, String sLibreta, String sRazon, String sEmail) {
		imagen = "TS135510";
		detalles = null;
	...
	public void TS135498_CRM_Movil_REPRO_Busqueda_Tipo_de_documento_Libreta_de_enrolamiento() {
		...
		boolean a = false;
		if (driver.findElement(By.id("SearchClientDocumentType")).getText().toLowerCase()
				.contains("libreta de enrolamiento")) {
			a = true;
		}
		Assert.assertTrue(a);
	}
	...
	public void TS_134379_CRM_Movil_Prepago_Vista_360_Mis_Servicios_Visualizacion_del_estado_de_los_servicios_activos_FAN_Front_OOCC(
			String sDNI) {
		imagen = "TS134379";
		detalles = null;
		detalles = imagen + "-Vista 360 - DNI: " + sDNI;
		...
		boolean a = false;
		driver.switchTo().frame(cambioFrame(driver,
				By.cssSelector(".slds-grid.slds-wrap.slds-card.slds-m-bottom--small.slds-p-around--medium")));
		List<WebElement> servicios = driver.findElement(By.className("slds-p-bottom--small"))
				.findElement(By.tagName("tbody")).findElements(By.tagName("tr"));
	...
	@Test(groups = { "GestionesPerfilOficina", "Nominacion",
			"Ciclo1" }, dataProvider = "DatosSalesNominacionNuevoPasaporteOfCom")
	public void TS128436_CRM_Movil_REPRO_Nominatividad_Presencial_DOC_Pasaporte_OfCom(String sLinea, String sPasaporte,
			String sNombre, String sApellido, String sSexo, String sPermanencia, String sFnac, String sEmail,
			String sProvincia, String sLocalidad, String sCalle, String sNumCa, String sCP) {
		imagen = "TS128436";
		detalles = null;
	...
	public void TS130071_CRM_Movil_REPRO_No_Nominatividad_Presencial_DOC_Edad_OfCom(String sLinea, String sDni,
			String sSexo, String sFnac) {
		imagen = "TS130071";
		detalles = null;
	...
	public void TS134495_CRM_Movil_Prepago_Vista_360_Distribucion_de_paneles_Informacion_del_cliente_FAN_Front_OOCC(
			String sDNI, String sLinea, String sNombre, String sEmail, String sMovil, String sNps,
			String sTelAlternativo, String sPuntosClub, String sCategoria) {
		imagen = "TS134495";
		detalles = null;
		...
		sleep(15000);
		driver.switchTo().frame(cambioFrame(driver, By.className("profile-box")));
		// Post: Se comparan los elementos de la primera tabla(Datos del Cliente) que se
		// visualiza con los datos del dataProvider
		WebElement nombre = driver.findElement(By.cssSelector(".slds-text-heading_large.title-card"));
		WebElement nps = driver.findElement(By.className("detail-card")).findElement(By.tagName("table"))
				.findElement(By.tagName("tbody")).findElements(By.tagName("tr")).get(2);
		WebElement acceso = driver.findElement(By.className("profile-links-wrapper"));
		WebElement dni = null;
		// System.out.println(nombre.getText()); System.out.println(nps.getText());
		// System.out.println(acceso.getText());
		...
		Assert.assertTrue(nombre.getText().contains(sNombre) && dni.getText().contains(sDNI) && acceso.isDisplayed()
				&& (nps.getText().contains(sNps) || nps.isDisplayed()));
		// Post: Se comparan los elementos de la segunda tabla que se visuliza (Datos
		// Personales) con los datos del dataProvider
		WebElement mail = driver.findElements(By.className("left-sidebar-section-container")).get(0)
				.findElement(By.tagName("table")).findElement(By.tagName("tbody")).findElements(By.tagName("tr"))
				.get(0);
		WebElement movil = driver.findElements(By.className("left-sidebar-section-container")).get(0)
				.findElement(By.tagName("table")).findElement(By.tagName("tbody")).findElements(By.tagName("tr"))
				.get(1);
		WebElement telefonoAlternativo = driver.findElements(By.className("left-sidebar-section-container")).get(0)
				.findElement(By.tagName("table")).findElement(By.tagName("tbody")).findElements(By.tagName("tr"))
				.get(2);
		WebElement puntosClubPersonal = driver.findElements(By.className("left-sidebar-section-container")).get(0)
				.findElement(By.tagName("table")).findElement(By.tagName("tbody")).findElements(By.tagName("tr"))
				.get(3);
		WebElement categoria = driver.findElements(By.className("left-sidebar-section-container")).get(0)
				.findElement(By.tagName("table")).findElement(By.tagName("tbody")).findElements(By.tagName("tr"))
				.get(4);
		// Imprimir los elemetos (Descomentar si es necesario para verificar que traiga
		// los elemetos)
		// System.out.println(mail.getText()); System.out.println(movil.getText());
		// System.out.println(telefonoAlternativo.getText());
		// System.out.println(puntosClubPersonal.getText());
		// System.out.println(categoria.getText());
		Assert.assertTrue(mail.getText().contains(sEmail) && (movil.getText().contains(sMovil) || movil.isDisplayed())
				&& (telefonoAlternativo.getText().contains(sTelAlternativo) || telefonoAlternativo.isDisplayed()));
		...
		// Post: Se comparan los elementos de la tercera tabla que se visualiza
		// (segmentacion) con los datos del dataProvider
		WebElement segmentoYAtriburo = driver.findElements(By.className("left-sidebar-section-container")).get(1)
				.findElement(By.tagName("table")).findElement(By.tagName("tbody")).findElement(By.tagName("tr"))
	...
	public void TS134745_CRM_Movil_Prepago_Vista_360_Producto_Activo_del_cliente_Datos_FAN_Front_OOCC(String sDNI,
			String sLinea, String sNombre) {
		imagen = "TS134745";
		detalles = null;
		detalles = imagen + " - Vista 360 - DNI: " + sDNI + " - Nombre: " + sNombre;
		...
		sleep(25000);
		driver.switchTo().frame(cambioFrame(driver, By.className("card-top")));
		WebElement plan = driver.findElement(By.className("card-top"))
				.findElements(By.className("slds-text-heading_medium")).get(0);
		WebElement FechaActivacion = driver.findElement(By.cssSelector(".slds-text-body_regular.expired-title"));
		WebElement linea = driver.findElement(By.className("card-top"))
				.findElements(By.className("slds-text-heading_medium")).get(2);
		System.out.println(plan.getText());
		System.out.println(FechaActivacion.getText());
	...
	public void TS134380_CRM_Movil_Prepago_Vista_360_Mis_Servicios_Visualizacion_del_estado_de_los_Productos_activos_FAN_Front_OOCC(
			String sDNI, String sNombre, String sLinea) {
		imagen = "TS134380";
		// Check all
		detalles = null;
		detalles = imagen + " - Vista 360 - DNI: " + sDNI;
	...
	public void TS134496_CRM_Movil_Prepago_Vista_360_Distribucion_de_paneles_Perfil_FAN_Front_OOCC(String sDNI,
			String sLinea, String sNombre) {
		imagen = "TS134496";
		detalles = null;
		detalles = imagen + " - Vista 360 - DNI: " + sDNI + " - Nombre: " + sNombre;
		...
		// driver.switchTo().defaultContent();
		// List<WebElement> pestanas =
		// driver.findElements(By.className("x-tab-strip-closable"));
	...
	@Test(groups = { "GestionesPerfilOficina", "ModificarDatos", "E2E",
			"Ciclo3" }, dataProvider = "CuentaModificacionDeDatos")
	public void TS134834_CRM_Movil_REPRO_Modificacion_de_datos_Actualizar_los_datos_del_cliente_completos_FAN_Front_OOCC(
			String sDNI, String sLinea) {
		imagen = "TS134834";
		detalles = null;
		...
		sleep(10000);
		Assert.assertTrue(
				driver.findElement(By.className("ta-care-omniscript-done")).findElement(By.className("ng-binding"))
						.getText().equalsIgnoreCase("Las modificaciones se realizaron con \u00e9xito!"));
		String orden = driver.findElement(By.cssSelector(".vlc-slds-inline-control__label.ng-binding")).getText();
		...
		assertTrue(cCBS.ObtenerValorResponse(cCBSM.Servicio_QueryCustomerInfo(sLinea), "bcc:FirstName")
				.equalsIgnoreCase(nuevoNombre));
		assertTrue(cCBS.ObtenerValorResponse(cCBSM.Servicio_QueryCustomerInfo(sLinea), "bcc:LastName")
				.equalsIgnoreCase(nuevoApellido));
		assertTrue(cCBS.ObtenerValorResponse(cCBSM.Servicio_QueryCustomerInfo(sLinea), "bcc:Birthday")
				.contains("19821010"));
		driver.switchTo().frame(cambioFrame(driver, By.className("profile-box")));
		driver.findElements(By.className("profile-edit")).get(0).click();
		sleep(10000);
	...
	@Test(groups = { "GestionesPerfilOficina", "ModificarDatos", "E2E",
			"Ciclo3" }, dataProvider = "CuentaModificacionDeDatos")
	public void TS129335_CRM_Movil_REPRO_Modificacion_de_datos_Actualizar_datos_campo_Correo_Electronico_Cliente_FAN_Front_OOCC(
			String sDNI, String sLinea) {
		imagen = "TS129335";
		detalles = null;
		detalles = imagen + " -ActualizarDatos - DNI: " + sDNI + " - Linea: " + sLinea;
	...
	@Test(groups = { "GestionesPerfilOficina", "ModificarDatos", "E2E",
			"Ciclo3" }, dataProvider = "CuentaModificacionDeDatos")
	public void TS129329_CRM_Movil_REPRO_Modificacion_de_datos_No_Permite_Actualizar_datos_campo_DNI_CUIT_Cliente_FAN_Front_OOCC(
			String sDNI, String sLinea) {
		imagen = "TS129329";
		detalles = null;
	...
	@Test(groups = { "GestionesPerfilOficina", "HistorialDeRecargas", "Ciclo2" }, dataProvider = "RecargasHistorias")
	public void TS_134787_CRM_Movil_Prepago_Historial_de_Recargas_Consultar_detalle_de_Recargas_con_Beneficios_FAN_Front_OOCC(
			String sDNI) {
		imagen = "TS134787";
		detalles = null;
		detalles = imagen + " - Historial de recargas - DNI:" + sDNI;
	...
	@Test(groups = { "GestionesPerfilOficina", "HistorialDeRecargas", "Ciclo2" }, dataProvider = "RecargasHistorias")
	public void TS_134788_CRM_Movil_Prepago_Historial_de_Recargas_Consultar_detalle_de_Recargas_Sin_Beneficios_FAN_Front_OOCC(
			String sDNI) {
		imagen = "TS134788";
		detalles = null;
		detalles = imagen + "- Historial de recargas - DNI: " + sDNI;
	...
	@Test(groups = { "GestionesPerfilOficina", "HistorialDeRecargas", "E2E",
			"Ciclo1" }, dataProvider = "HistoriaRecarga")
	public void TS135468_CRM_Movil_Prepago_Historial_de_Packs_Nombre_del_Pack_TODOS_FAN_Front_OOCC(String sDNI,
		...
		driver.findElement(By.id("text-input-03")).click();
		sleep(2000);
		List<WebElement> todos = driver.findElement(By.cssSelector(".slds-dropdown__list.slds-dropdown--length-5"))
				.findElements(By.tagName("li"));
	...
	@Test(groups = { "GestionesPerfilOficina", "HistorialDeRecargas", "E2E",
			"Ciclo1" }, dataProvider = "RecargasHistorias")
	public void TS135361_CRM_Movil_Prepago_Otros_Historiales_Historial_de_ajustes_FAN_Front_OOCC_S138(String sDNI) {
		...
		Assert.assertTrue(driver
				.findElement(By.cssSelector(
						".slds-table.slds-table--bordered.slds-table--resizable-cols.via-slds-table-pinned-header"))
				.isDisplayed());

	}

	@Test(groups = { "GestionesPerfilOficina", "VentaDePacks",
			"Ciclo1" }, priority = 1, dataProvider = "ventaPack50ofic")
	public void TS139727_CRM_Movil_REPRO_Venta_de_pack_50_min_y_50_SMS_x_7_dias_Factura_de_Venta_Efectivo_OOCC(
			String sDNI, String sLinea, String sventaPack) throws AWTException {
		imagen = "TS139727";
		detalles = null;
	...
	public void TS123163_CRM_Movil_REPRO_Venta_de_pack_1000_min_a_Personal_y_1000_SMS_x_1_dia_Factura_de_Venta_TC_Presencial(
			String sDNI, String sLinea, String sVentaPack, String sBanco, String sTarjeta, String sPromo,
			String sCuotas, String sNumTarjeta, String sVenceMes, String sVenceAno, String sCodSeg, String sTipoDNI,
			String sDNITarjeta, String sTitular) throws KeyManagementException, NoSuchAlgorithmException {
		imagen = "TS123163";
		detalles = null;
		detalles = imagen + "- Venta de pack - DNI: " + sDNI + " - Linea: " + sLinea;
		SalesBase sale = new SalesBase(driver);
		...
		pagePTelefo.getMediodePago().click();
		sleep(45000);
		pagePTelefo.getOrdenSeRealizoConExito().click();// No se puede procesr (Ups, hay problemas para procesar su
														// pago.)
		sleep(10000);
		String orden = cCC.obtenerTNyMonto2(driver, sOrden);
		detalles += "-Monto:" + orden.split("-")[1] + "-Prefactura:" + orden.split("-")[0];
	...
	public void TS135483_CRM_Movil_Prepago_Historial_de_Packs_Seleccion_de_Fechas_FAN_Front_OOCC(String sDNI) {
		...
		driver.switchTo().frame(cambioFrame(driver, By.cssSelector(
				".slds-grid.slds-wrap.slds-grid--pull-padded.slds-m-around--medium.slds-p-around--medium.negotationsfilter")));
		sleep(5000);
		WebElement visu = driver.findElement(By.cssSelector(
				".slds-grid.slds-wrap.slds-grid--pull-padded.slds-m-around--medium.slds-p-around--medium.negotationsfilter"));
		Assert.assertTrue(visu.isDisplayed());
	}

	@Test(groups = { "GestionesPerfilOficina", "NumerosAmigos", "E2E",
			"Ciclo1" }, dataProvider = "NumerosAmigosNoPersonalModificacion")
	public void TS_CRM_Movil_REPRO_FF_No_Modificacion_Presencial(String sDNI, String sLinea, String sNumeroVOZ,
			String sNumeroSMS) {
		imagen = "TS";
		detalles = null;
		...
		switch (iIndice) {
		case 0:
			Assert.assertTrue(driver.findElements(By.cssSelector("[class='vlc-slds-error-block']")).get(0)
					.findElement(By.cssSelector("[class='error']")).getText()
					.equalsIgnoreCase("La linea no pertenece a Telecom, verifica el n\u00famero."));
			break;
		case 1:
			Assert.assertTrue(driver.findElements(By.cssSelector("[class='vlc-slds-error-block']")).get(1)
					.findElement(By.cssSelector("[class='error']")).getText()
					.equalsIgnoreCase("La linea no pertenece a Telecom, verifica el n\u00famero."));
			break;
		default:
	...
	@Test(groups = { "GestionesPerfilOficina", "NumerosAmigos", "E2E",
			"Ciclo1" }, dataProvider = "NumerosAmigosNoPersonalAlta")
	public void TS100607_CRM_Movil_REPRO_FF_No_Alta_Amigo_No_Personal_Presencial(String sDNI, String sLinea,
			String sNumeroVOZ, String sNumeroSMS) {
		imagen = "TS100607";
		detalles = null;
		detalles = imagen + "- Numeros Amigos - DNI:" + sDNI + " - Linea: " + sLinea;
		BasePage cambioFrame = new BasePage();
	...
	@Test(groups = { "GestionesPerfilOficina", "NumerosAmigos", "E2E",
			"Ciclo1" }, dataProvider = "NumerosAmigosNoPersonalBaja")
	public void TS100612_CRM_Movil_REPRO_FF_No_Baja_Presencial(String sDNI, String sLinea, String sVOZorSMS)
		...
		// sleep(20000);
		Assert.assertTrue(driver.findElement(By.id("ErrorTB")).getText().toLowerCase()
				.contains("no fue posible realizar el cambio"));
		Assert.assertTrue(driver.findElement(By.id("ErrorTB")).getText().toLowerCase()
				.contains("orden cancelada a pedido del cliente"));
		Assert.assertTrue(sMainBalance
				.equals(cCBS.ObtenerValorResponse(cCBSM.Servicio_queryLiteBySubscriber(sLinea), "bcs:MainBalance")));
	}

	@Test(groups = { "GestionesPerfilOficina", "Vista360", "E2E", "Ciclo 1" }, dataProvider = "CuentaVista360")
	public void TS134371_CRM_Movil_Prepago_Vista_360_Consulta_por_gestiones_Gestiones_abiertas_Plazo_No_vencido_Consulta_registrada_FAN_Front_OOCC(
			String sDNI, String sNombre, String sLinea) {
		imagen = "TS134371";
		detalles = null;
		detalles = imagen + "- Vista 360 - DNI: " + sDNI;
	...
	@Test(groups = { "GestionesPerfilOficina", "Vista360", "E2E", "ConsultaPorGestion",
			"Ciclo2" }, dataProvider = "CuentaModificacionDeDatos")
	public void TS134370_CRM_Movil_Prepago_Vista_360_Consulta_por_gestiones_Gestiones_no_registradas_FAN_Front_OOCC(
			String sDNI, String sLinea) {
		imagen = "TS134370";
		detalles = null;
		detalles = imagen + "- Vista 360 - DNI: " + sDNI;
	...
	@Test(groups = { "GestionesPerfilOficina", "RenovacionDeCuota", "E2E",
			"Ciclo1" }, dataProvider = "RenovacionCuotaSinSaldo")
	public void TS135512_CRM_Movil_REPRO_No_Renovacion_de_cuota_Pack_de_datos_Activo_Presencial(String sDNI,
			String sLinea) {
		imagen = "TS135512";
		detalles = null;
		...
		sleep(3000);
		WebElement msj = driver.findElement(By.cssSelector(
				".slds-form-element.vlc-flex.vlc-slds-radio-control.ng-scope.ng-dirty.ng-valid-parse.ng-valid.ng-valid-required"));
		...
		Assert.assertTrue(false);// investigar si debe ser asi o si debe negar la activacion del pack si ya esta
									// activo
	}

	@Test(groups = { "GestionesPerfilOficina", "Vista360", "Ciclo2" }, dataProvider = "CuentaVista360")
	public void TS134349_CRM_Movil_Prepago_Vista_360_Consulta_por_gestiones_Gestiones_abiertas_Plazo_vencido_Asistencia_registrada_FAN_Front_OOCC(
			String sDNI, String sLinea, String sNombre) {
		imagen = "TS134349";
		detalles = null;
		detalles = imagen + " - Vista 360 - DNI: " + sDNI + " - Nombre: " + sNombre;
		driver.switchTo().frame(cambioFrame(driver, By.id("SearchClientDocumentType")));
		...
		driver.findElement(By.cssSelector(
				...
				.click();
		sleep(10000);
		WebElement nroCaso = driver.findElement(By.cssSelector(".slds-p-bottom--small"))
				.findElement(By.tagName("table")).findElement(By.tagName("tbody")).findElement(By.tagName("tr"))
				.findElements(By.tagName("td")).get(2).findElement(By.tagName("div")).findElement(By.tagName("a"));
		...
		Assert.assertTrue(fechaYHora.findElements(By.tagName("td")).get(3).getText()
	...
	public void TS121362_CRM_Movil_REPRO_Servicio_Tecnico_Realiza_configuraciones_de_equipos_Validacion_de_IMEI_Ok_Sin_Garantia_Sin_Muleto_Reparar_ahora_No_acepta_presupuesto_ofCom(
			String sDNI, String sIMEI, String sEmail, String sLinea, String sOpcion, String sOperacion, String sSintoma)
		...
		sleep(8000);
		driver.switchTo()
				.frame(cambioFrameByID.getFrameForElement(driver, By.cssSelector(".imgItemContainer.ng-scope")));
		...
		try {
			...
			driver.findElement(By.cssSelector(".vlc-slds-remote-action__content.ng-scope"))
					.findElement(By.xpath("//*[@id=\"PopulateRepairs\"]/div/p[3]"));
			List<WebElement> butt = driver
		...
		((JavascriptExecutor) driver).executeScript(
				"window.scrollTo(0," + driver.findElement(By.className("vlc-control-wrapper")).getLocation().y + " )");
		...
		List<WebElement> sint = driver.findElement(By.cssSelector(".slds-list--vertical.vlc-slds-list--vertical"))
				.findElements(By.tagName("li"));
	...
	public void TS121372_CRM_Movil_REPRO_Servicio_Tecnico_Realiza_reparaciones_de_equipos_Busqueda_de_cliente_Reparacion_Sin_Muleto_Equipo_en_destruccion_total_Con_seguro_de_proteccion_total_No_se_pudo_realizar_la_reparacion_OfCom(
		...
		sleep(8000);
		driver.findElement(
				By.cssSelector(".slds-form-element__control.slds-input-has-icon.slds-has-input-has-icon--right"));
		selectByText(driver.findElement(By.id("SelectOperationType")), sOperacion);
		sleep(8000);
		...
		List<WebElement> soluciones = driver.findElement(By.cssSelector(
				".slds-table.slds-table--bordered.slds-table--cell-buffer.techCare-PriceListSelection.ng-scope"))
				.findElement(By.tagName("tbody")).findElements(By.tagName("tr"));
		...
		List<WebElement> costo = driver.findElement(By.cssSelector(
				".slds-table.slds-table--bordered.slds-table--cell-bufferslds-m-bottom--x-large.ta-table-list.ng-scope"))
				.findElement(By.tagName("tbody")).findElements(By.tagName("tr"));
		...
		sleep(8000);
		List<WebElement> presup = driver.findElement(By.className("slds-form-element__control"))
				.findElement(By.tagName("label")).findElements(By.tagName("div"));
		...
		buscarYClick(driver.findElements(By.cssSelector(".slds-button.slds-button--neutral.TechCare-createOrder-Btn")),
				"equals", "crear orden");

	}

	@Test(groups = { "GestionesPerfilOficina", "DiagnosticoInconvenientes", "E2E",
			"Ciclo3" }, dataProvider = "Diagnostico")
	public void TS111871_CRM_Movil_REPRO_Diagnostico_SVA_Configuracion_Disponible_Presencial_SMS_Saliente_SMS_a_fijo_Geo_No_Ok_Desregistrar_OfCom(
			String sDNI, String sLinea) throws Exception {
		imagen = "TS111871";
		detalles = null;
		detalles = imagen + " -ServicioTecnico - DNI: " + sDNI + " - Linea: " + sLinea;
	...
	public void TS85099_CRM_Movil_REPRO_Nominatividad_Cliente_Existente_Presencial_Preguntas_Y_Respuestas_Ofcom(
			String sLinea, String sDni, String sNombre, String sApellido, String sSexo, String sFnac, String sEmail,
			String sProvincia, String sLocalidad, String sCalle, String sNumCa, String sCP) {
	...
	public void TS100978_CRM_REPRO_BDC_Customer_Care_Suspensiones_y_Rehabilitaciones_Perfil_OOCC_Acceso_a_base_de_conocimiento(
			String sDNI, String sLinea, String sNombre, String sEmail, String sMovil) {
		imagen = "TS100978";
		detalles = null;
	...
	@Test(groups = { "GestionesPerfilOficina", "BaseDeConocimiento", "Ciclo3" }, dataProvider = "CuentaVista360")
	public void TS125107_CRM_REPRO_BDC_Customer_Care_Problemas_con_recargas_Tarjetas_Prepagas_Verificar_acceso_a_BC(
			String sDNI, String sLinea, String sNombre, String sEmail, String sMovil) {
		imagen = "TS125107";
		detalles = null;
	...
	@Test(groups = { "GestionesPerfilOficina", "BaseDeConocimiento", "Ciclo3" }, dataProvider = "CuentaVista360")
	public void TS130755_CRM_REPRO_BDC_Customer_Care_Problemas_con_Recargas_PerfilTelefonico_Articulo_de_Medios_de_Recargas(
			String sDNI, String sLinea, String sNombre, String sEmail, String sMovil) {
		imagen = "TS125107";
		detalles = null;
		detalles = imagen + "- Base de Conocimiento - DNI: " + sDNI + " - Nombre: " + sNombre;
		...
		Assert.assertTrue(driver.findElement(By.className("vlc-slds-knowledge-list-item")).getText()
				.contains("Problemas con recargas Online"));
	}

	@Test(groups = { "GestionPerfilOficina", "BasedeConocimiento", "Ciclo3" }, dataProvider = "BaseDeConocimiento")
	public void TS124899_CRM_REPRO_BDC_Technical_Care_CSR_Suscripciones_Base_de_Conocimiento(String sDNI,
			String sLinea) {
		imagen = "TS124899";
		detalles = null;
		...
		Assert.assertTrue(
				driver.findElement(By.className("community-flyout-actions-card")).getText().contains("Suscripciones"));
		sleep(3000);
		cc.irAGestionEnCard("Suscripciones");
		sleep(7000);
		driver.switchTo().defaultContent();
	...
	@Test(groups = { "GestionPerfilOficina", "BasedeConocimiento", "Ciclo3" }, dataProvider = "BaseDeConocimiento")
	public void TS125103_CRM_REPRO_BDC_Customer_Care_Suspensiones_y_Rehabilitaciones_Valoracion_positiva_de_un_articulo(
			String sDNI, String sLinea) {
		imagen = "TS125103";
		detalles = null;
	...
	@Test(groups = { "GestionPerfilOficina", "BasedeConocimiento", "Ciclo3" }, dataProvider = "BaseDeConocimiento")
	public void TS124900_CRM_REPRO_BDC_Technical_Care_CSR_Inconvenientes_con_Servicios_Varios_Base_de_Conocimiento(
			String sDNI, String sLinea) {
		imagen = "TS124900";
		detalles = null;
	...
	public void TC135738_CRM_Movil_REPRO_Baja_de_Servicio_sin_costo_Voice_Mail_con_Clave_Presencial_OfCom(String sDNI,
			String sLinea) throws AWTException {
		imagen = "TS135738";
		detalles = null;
	...
	@Test(groups = { "GestionesPerfilOficina", "E2E", "Ciclo3", "ABMDeServicios" }, dataProvider = "BajaServicios")
	public void TS135739_CRM_Movil_REPRO_Baja_de_Servicio_sin_costo_DDI_sin_Roaming_Internacional_Presencial_OfCom(
			String sDNI, String sLinea) throws AWTException {
		imagen = "TS135739";
		detalles = null;
		detalles = imagen + "- BajaServicio - DNI: " + sDNI + " - Linea: " + sLinea;
		GestionFlow gGF = new GestionFlow();
		Assert.assertTrue(
				gGF.FlowConsultaServicioActivo(driver, sLinea, "Discado Directo Internacional sin Roaming Int."));
		BasePage cambioFrameByID = new BasePage();
		sleep(30000);
		driver.switchTo().frame(cambioFrameByID.getFrameForElement(driver, By.id("SearchClientDocumentType")));
		sleep(1000);
	...
	public void TC135744_CRM_Movil_REPRO_Alta_Servicio_sin_costo_Voice_Mail_con_Clave_Presencial_OfCom(String sDNI,
			String sLinea) throws AWTException {
		imagen = "TS135744";
		detalles = null;
		detalles = imagen + "- AltaServicio - DNI: " + sDNI + " - Linea: " + sLinea;
		GestionFlow gGF = new GestionFlow();
		// Assert.assertTrue(gGF.FlowConsultaServicioInactivo(driver, sLinea, "Voice
		// Mail con Clave"));
		BasePage cambioFrameByID = new BasePage();
		sleep(30000);
		driver.switchTo().frame(cambioFrameByID.getFrameForElement(driver, By.id("SearchClientDocumentType")));
		...
		sleep(15000);
		ppt = new PagePerfilTelefonico(driver);
		ppt.altaBajaServicioContestador("Alta", "Servicios basicos general movil", "Contestador",
				"Voice Mail con Clave", driver);
		driver.findElement(By.cssSelector(".slds-button.slds-m-left--large.slds-button--brand.ta-button-brand"))
				.click();// Continuar
		// ppt.getwAltaBajaContinuar().click();//Continuar
		sleep(20000);
	...
	@Test(groups = { "GestionesPerfilOficina", "E2E", "Ciclo3", "ABMDeServicios" }, dataProvider = "AltaServicios")
	public void TS135745_CRM_Movil_REPRO_Alta_Servicio_sin_costo_DDI_sin_Roaming_Internacional_Presencial_OfCom(
			String sDNI, String sLinea) throws AWTException {
		imagen = "TS135745";
		detalles = imagen + " - AltaServicio - DNI: " + sDNI + " - Linea: " + sLinea;
		GestionFlow gGF = new GestionFlow();
		Assert.assertTrue(
				gGF.FlowConsultaServicioInactivo(driver, sLinea, "Discado Directo Internacional sin Roaming Int."));
		BasePage cambioFrameByID = new BasePage();
		sleep(30000);
		driver.switchTo().frame(cambioFrameByID.getFrameForElement(driver, By.id("SearchClientDocumentType")));
		sleep(1000);
		...
		sleep(15000);
		ppt = new PagePerfilTelefonico(driver);
		// Al dar de baja DDI con roaming internacional se activa el boton para dar de
		// alta el DDI sin roaming internacional
		ppt.altaBajaServicio("baja", "Servicios basicos general movil", "DDI", "DDI con Roaming Internacional", driver);
		driver.findElement(By.cssSelector(".slds-button.slds-m-left--large.slds-button--brand.ta-button-brand"))
				.click();// Continuar
		// ppt.getwAltaBajaContinuar().click();//Continuar
	...
	@Test(groups = { "GestionesPerfilOficina", "BaseDeConocimiento", "Ciclo3" }, dataProvider = "CuentaVista360")
	public void TS125098_CRM_REPRO_BDC_Customer_Care_Problemas_con_recargas_Valoracion_negativa_en_BC(String sDNI,
			String sLinea, String sNombre, String sEmail, String sMovil) {
		imagen = "TS125098";
		detalles = null;
		detalles = imagen + "-Base de Conocimiento - DNI: " + sDNI + " - Nombre: " + sNombre;
		...
		driver.findElement(By.cssSelector(".articleListContainer.loaded")).findElement(By.className("articleEntry"))
				.findElement(By.tagName("a")).click();
		sleep(5000);
		driver.switchTo().frame(cambioFrame(driver, By.className("articleRendererBorderRight")));
		WebElement negativo = driver.findElement(By.className("articleRendererBorderRight"))
				.findElements(By.tagName("td")).get(1).findElements(By.tagName("a")).get(1);
	...
	// =========================== ESTE VA 2 ============================
	@Test(groups = { "GestionesPerfilOficina", "CambioDeSimcard", "E2E",
			"Ciclo3" }, priority = 1, dataProvider = "SimCardSiniestroOfCom")
	public void TS99030_CRM_Movil_REPRO_Cambio_de_SimCard_Presencial_Siniestro_Ofcom(String sDNI, String sLinea)
			throws AWTException {
		imagen = "99030";
		detalles = null;
		detalles = imagen + "-DNI:" + sDNI;
	...
	// @Test(groups = { "GestionesPerfilOficina","CambioSimcardDer", "E2E","Ciclo3"
	// }, priority = 1, dataProvider = "CambioSimCardOficina")
	public void TS134381_CRM_Movil_REPRO_Cambio_de_simcard_sin_costo_Voluntario_Ofcom_Presencial_Con_entega_de_pedido(
			String sDNI, String sLinea) throws AWTException {
		imagen = "134381";
		detalles = null;
		detalles = imagen + "-DNI:" + sDNI;
	...
	public void TS104346_CRM_Movil_Repro_Problemas_con_Recarga_Presencial_On_Line_Ofcom(String sDNI, String sLinea) {
		...
		driver.findElement(By.id("Summary_nextBtn")).click();
		sleep(5000);
		WebElement gestion = driver.findElement(By.className("ta-care-omniscript-done"))
				.findElement(By.tagName("header")).findElement(By.tagName("h1"));
	...
	@Test(groups = { "ProblemasConRecargas", "GestionesPerfilOficina", "E2E",
			"Ciclo3" }, dataProvider = "CuentaProblemaRecarga")
	public void TS104351_CRM_Movil_Repro_Problemas_con_Recarga_On_line_Sin_comprobante_En_espera_del_cliente_Ofcom(
			String sDNI, String sLinea) {
		imagen = "TS104351";
		driver.switchTo().frame(cambioFrame(driver, By.id("SearchClientDocumentType")));
		sb.BuscarCuenta("DNI", sDNI);
	...
	@Test(groups = { "ProblemasConRecargas", "GestionesPerfilOficina", "E2E",
			"Ciclo3" }, dataProvider = "CuentaProblemaRecargaAYD")
	public void TS104353_CRM_Movil_Repro_Problemas_con_Recarga_Presencial_Tarjeta_Scratch_Caso_Nuevo_Tarjeta_Activa_y_Disponible_Ofcom(
			String sDNI, String sLinea, String sSerie, String sPIN) {
		imagen = "TS104353";
		detalles = null;
		detalles = imagen + " -Problemas Con Recargas-DNI: " + sDNI;
		String datoViejo = cbs.ObtenerValorResponse(cbsm.Servicio_queryLiteBySubscriber(sLinea), "bcs:MainBalance");
	...
	@Test(groups = { "GestionesPerfilTelefonico", "HistorialDeRecargas", "E2E",
			"Ciclo2" }, dataProvider = "HistoriaRecarga")
	public void TS134840_CRM_Movil_Prepago_Historial_de_Recargas_Consultar_detalle_de_Recargas_por_Fecha_Fan_FRONT_OOCC(
			String sDNI, String sLinea) {
		imagen = "TS134840";
		detalles = null;
		...
		driver.findElement(By.cssSelector(
				...
				.click();
		sleep(5000);
		WebElement fecha = driver
				.findElement(By.cssSelector(".slds-p-bottom--small.slds-p-left--medium.slds-p-right--medium"))
				.findElement(By.tagName("tr")).findElement(By.tagName("th"));
	...
	public void TS134747_CRM_Movil_Prepago_Historial_de_Recargas_S141_FAN_Front_OOCC(String sDNI, String sLinea) {
		...
		driver.switchTo().frame(cambioFrame(driver,
				By.cssSelector(".slds-grid.slds-wrap.slds-card.slds-m-bottom--small.slds-p-around--medium")));
		WebElement conf = driver.findElement(
				By.cssSelector(".slds-grid.slds-wrap.slds-card.slds-m-bottom--small.slds-p-around--medium"));
	...
	@Test(groups = { "GestionesPerfilOficina", "DiagnosticoInconvenientes", "E2E",
			"Ciclo3" }, dataProvider = "Diagnostico")
	public void TS119262_CRM_Movil_REPRO_Diagnostico_de_Voz_Valida_Red_y_Navegacion_Motivo_de_contacto_No_puedo_Llamar_desde_otro_pais_Sin_Locacion_NO_recupera_locacion_Geo_Fuera_de_area_de_cobertura_OfCom(
			String sDNI, String sLinea) throws Exception {
		boolean caso = false;
		imagen = "TS119262";
		detalles = null;
	...
	@Test(groups = { "GestionesPerfilOficina", "ModificarDatos", "E2E",
			"Ciclo3" }, dataProvider = "CuentaModificacionDeDNI")
	public void TS129325_CRM_Movil_REPRO_Modificacion_de_datos_Actualizar_datos_campo_DNI_CUIT_Cliente_FAN_Front_OOCC(
			String sDNI, String sLinea) {
		imagen = "TS129325";
		detalles = null;
	...
	public void TS129472_CRM_Movil_Prepago_Resumen_de_Cuenta_Corriente_Columnas_de_informacion_Pagos_FAN_Front_OOCC(
			String sDNI, String sLinea, String sNombre, String sEmail, String sMovil) {
		imagen = "TS129472";
		driver.switchTo().frame(cambioFrame(driver, By.id("SearchClientDocumentType")));
		sb.BuscarCuenta("DNI", sDNI);
		...
		WebElement tabla = driver
				.findElement(By.cssSelector(
						".slds-size--1-of-1.slds-medium-size--1-of-1.slds-large-size--1-of-1.slds-m-top--x-large"))
				.findElement(By.className("slds-text-heading--label"));
	...
	@Test(groups = { "ProblemasConRecargas", "GestionesPerfilOficina", "E2E",
			"Ciclo3" }, dataProvider = "CuentaProblemaRecarga")
	public void TS104352_CRM_Movil_REPRO_Problemas_con_Recarga_Presencial_Tarjeta_Scratch_Caso_Nuevo_Pin_Borrado(
			String sDNI, String sLinea) {
		imagen = "TS104352";
	...
	@Test(groups = { "GestionesPerfilOficina", "HistorialDeRecargas", "E2E",
			"Ciclo1" }, dataProvider = "RecargasHistorias")
	public void TS135476_CRM_Movil_Prepago_Historial_de_Packs_Nombre_del_Pack_Plan_Internet_50_Mb_FAN_Front_OOCC(
			String sDNI) {
		imagen = "TS135476";
		detalles = null;
		...
		sleep(8000);
		driver.findElement(By.id("text-input-03")).click();
		List<WebElement> NomPack = driver.findElement(By.cssSelector(".slds-dropdown__list.slds-dropdown--length-5"))
				.findElements(By.tagName("li"));
	...
	@Test(groups = { "GestionesPerfilOficina", "ResumenDeCuenta", "E2E",
			"Ciclo4" }, dataProvider = "CuentaModificacionDeDatos")
	public void TS129471_CRM_Movil_Prepago_Resumen_de_Cuenta_Corriente_Columnas_de_informacion_Comprobantes_FAN_Front_OOCC(
			String sDNI, String sLinea) {
		imagen = "TS129471";
		detalles = null;
	...
	@Test(groups = { "GestionesPerfilOficina", "ModificarDatos", "E2E",
			"Ciclo3" }, dataProvider = "CuentaModificacionDeDatos")
	public void TS84240_CRM_Movil_REPRO_Modificacion_de_datos_No_Actualizar_datos_Cliente_FAN_Front_OOCC(String sDNI,
			String sLinea) {
		imagen = "TS84240";
		detalles = null;
		detalles = imagen + " -ActualizarDatos - DNI: " + sDNI + " - Linea: " + sLinea;
	...
	public void TS129462_CRM_Movil_Prepago_Resumen_de_Cuenta_Corriente_Validaciones_de_logica_de_filtros_Fecha_FAN_Front_OOCC(
			String sDNI) {
		imagen = "TS129462";
		detalles = null;
		...
		Assert.assertTrue(driver
				.findElement(By.cssSelector(
						".slds-p-horizontal--small.slds-size--1-of-2.slds-medium-size--1-of-4.slds-large-size--1-of-4"))
				.isDisplayed());
	}

	@Test(groups = { "GestionesPerfilOficina", "ResumenDeCuenta", "E2E", "Ciclo2" }, dataProvider = "CuentaVista360")
	public void TS129476_CRM_Movil_Prepago_Resumen_de_Cuenta_Corriente_Detalle_ampliado_registro_de_Comprobante_Factura_de_Venta_FAN_Front_OOCC(
			String sDNI, String sLinea, String sNombre, String sEmail, String sMovil) {
		imagen = "TS129476";
		detalles = null;
		...
		sleep(5000);
		cc.irAResumenDeCuentaCorriente();
		driver.switchTo().frame(tb.cambioFrame(driver, By.cssSelector(
				".slds-button.slds-button--brand.filterNegotiations.slds-p-horizontal--x-large.slds-p-vertical--x-small.secondaryFont")));
		...
		sleep(10000);
		boolean conf = false;
		List<WebElement> tablas = driver.findElements(
				By.cssSelector(".slds-grid.slds-wrap.slds-card.slds-m-bottom--small.slds-p-around--medium"));
		...
		List<WebElement> Tabla = driver.findElement(By.className("slds-p-bottom--small"))
				.findElement(By.tagName("table")).findElement(By.tagName("tbody")).findElements(By.tagName("tr"));
		...
		WebElement comprobante = driver
				.findElement(By.cssSelector(".slds-wrap.slds-card.slds-m-bottom--small.slds-p-around--medium"));
	...
	public void TS105428_CRM_Movil_Repro_Autogestion_USSD_No_Interactua_Resuelto(String cDNI, String cLinea)
			throws InterruptedException {
		imagen = "TS105428";
		detalles = null;
	...
	@Test(groups = { "GestionesPerfilOficina", "DiagnosticoInconvenientes", }, dataProvider = "Diagnostico")
	public void TS105431_CRM_Movil_Repro_Autogestion_WAP_Sitio_Caido_No_carga_informacion_Resuelto(String cDNI,
			String cLinea) throws InterruptedException {
		imagen = "TS105431";
		detalles = null;
		detalles = imagen + "- Autogestion - DNI: " + cDNI;
		TechnicalCareCSRAutogestionPage tech = new TechnicalCareCSRAutogestionPage(driver);
	...
	@Test(groups = { "GestionesPerfilOficina", "DiagnosticoInconvenientes", }, dataProvider = "Diagnostico")
	public void TS105831_Nros_Emergencia_Informa_Sistema_Fuera_de_Servicio_Resuelto(String cDNI, String cLinea)
			throws InterruptedException {
		imagen = "TS105831";
		detalles = null;
		detalles = imagen + "- Autogestion - DNI: " + cDNI;
	...
	@Test(groups = { "GestionesPerfilOficina", "CambioDeSimcard", "E2E",
			"Ciclo3" }, priority = 1, dataProvider = "SimCardSiniestroOfCom")
	public void TS134382_CRM_Movil_REPRO_Cambio_de_simcard_sin_costo_Siniestro_Ofcom_Presencial_Con_entega_de_pedido(
			String sDNI, String sLinea) throws AWTException {
		imagen = "134382";
		detalles = null;
		detalles = imagen + "-DNI:" + sDNI;
	...
	// @Test(groups = { "GestionesPerfilTelefonico","CambioDeSimcardDer", "E2E" },
	// priority = 1, dataProvider = "SimCardSiniestroOfCom")
	public void TS134406_OF_COM_CRM_Movil_REPRO_Cambio_de_simcard_con_costo_Siniestro_Ofcom_Store_pickUp_Con_entega_de_pedido_pago_en_Efectivo(
			String sDNI, String sLinea) {
		imagen = "134406";
		detalles = null;
		detalles = imagen + "-DNI:" + sDNI;
	...
	// @Test(groups = { "GestionesPerfilTelefonico","CambioSimCardDer", "E2E" },
	// priority = 1, dataProvider = "SimCardSiniestroAG") //NO APARECE EL MEDIO DE
	// PAGO
	public void TS134407_CRM_Movil_REPRO_Cambio_de_simcard_con_costo_Siniestro_Ofcom_Store_pickUp_Con_entega_de_pedido_pago_con_TD(
			String sDNI, String sLinea, String cEntrega, String cProvincia, String cLocalidad, String cPuntodeVenta,
			String cBanco, String cTarjeta, String cPromo, String cCuotas, String cNumTarjeta, String cVenceMes,
			String cVenceAno, String cCodSeg, String cTipoDNI, String cDNITarjeta, String cTitular) {
		imagen = "134407";
		detalles = null;
		detalles = imagen + "-DNI:" + sDNI;
		SalesBase sale = new SalesBase(driver);
	...
	@Test(groups = { "GestionesPerfilOficina", "Vista360", "Ciclo2" }, dataProvider = "CuentaVista360")
	public void TS134368_OFCOM_CRM_Movil_Prepago_Vista_360_Detalle_de_consumo_Consulta_visualizacion_y_busqueda_de_los_distintos_consumos_realizados_por_el_cliente_FAN_Front_OOCC(
			String sDNI, String sLinea, String sNombre) {
		imagen = "TS134368";
		detalles = null;
		detalles = imagen + "-Vista 360 - DNI: " + sDNI + " - Nombre: " + sNombre;
		...
		Assert.assertTrue(a);
		Select pagina = new Select(
				driver.findElement(By.cssSelector(".slds-select.ng-pristine.ng-untouched.ng-valid.ng-not-empty")));
		pagina.selectByVisibleText("30");
		sleep(7500);
		boolean b = false;
		WebElement lista = driver
				.findElement(By.cssSelector(".slds-p-bottom--small.slds-p-left--medium.slds-p-right--medium"))
				.findElement(By.tagName("table")).findElement(By.tagName("tbody"));
	...
	@Test(groups = { "GestionesPerfilOficina", "HistorialDeRecargas", "E2E",
			"Ciclo2" }, dataProvider = "HistoriaRecarga")
	public void TS134786_CRM_Movil_Prepago_Historial_de_Recargas_Monto_total_FAN_Front_OOCC(String sDNI,
			String sLinea) {
		imagen = "TS134786";
		detalles = imagen + "-Historial De Recarga-DNI:" + sDNI;
		driver.switchTo().frame(cambioFrame(driver, By.id("SearchClientDocumentType")));
		...
		sleep(3000);
		driver.switchTo().frame(cambioFrame(driver, By.cssSelector(
				".slds-size--1-of-1.slds-medium-size--1-of-1.slds-large-size--1-of-1.slds-p-bottom--small.slds-p-left--medium")));
		driver.findElement(By.cssSelector(
				".slds-button.slds-button--brand.filterNegotiations.slds-p-horizontal--x-large.slds-p-vertical--x-small"))
				.click();
		sleep(3000);
	...
	@Test(groups = { "GestionesPerfilOficina", "E2E", "Ciclo3", "ABMDeServicios" }, dataProvider = "BajaServicios")
	public void TS134335_CRM_Movil_PRE_Baja_de_Servicio_sin_costo_Llamadas_WiFi_Presencial(String sDNI, String sLinea)
			throws AWTException {
		imagen = "TS134335";
		detalles = null;
		detalles = imagen + "-BajaServicio-DNI:" + sDNI;
	...
	@Test(groups = { "GestionesPerfilOficina", "E2E", "Ciclo3", "ABMDeServicios" }, dataProvider = "BajaServicios")
	public void TS134339_CRM_Movil_PRE_Baja_de_Servicio_sin_costo_DDI_sin_Roaming_Internacional_Presencial(String sDNI,
			String sLinea) throws AWTException {
		imagen = "TS134339";
		detalles = null;
		detalles = imagen + "- BajaServicio - DNI: " + sDNI + " - Linea: " + sLinea;
	...
	@Test(groups = { "GestionesPerfilOficina", "E2E", "Ciclo3", "ABMDeServicios" }, dataProvider = "AltaServicios")
	public void TS134352_CRM_Movil_PRE_Alta_Servicio_sin_costo_Llamadas_WiFi_Presencial(String sDNI, String sLinea)
			throws AWTException {
		imagen = "TS134352";
		detalles = null;
		detalles = imagen + "-AltaServicio-DNI:" + sDNI;
	...
	@Test(groups = { "GestionesPerfilOficina", "E2E", "Ciclo3", "ABMDeServicios" }, dataProvider = "AltaServicios")
	public void TS134356_CRM_Movil_PRE_Alta_Servicio_sin_costo_DDI_sin_Roaming_Internacional_Presencial(String sDNI,
			String sLinea) throws AWTException {
		imagen = "TS134356";
		detalles = imagen + " - AltaServicio - DNI: " + sDNI + " - Linea: " + sLinea;
		GestionFlow gGF = new GestionFlow();
	...
	@Test(groups = { "GestionesPerfilOficina", "Recargas", "E2E", "Ciclo1" }, dataProvider = "RecargaTC")
	public void TS134319_CRM_Movil_REPRO_Recargas_Presencial_TC_Ofcom(String sDNI, String sMonto, String sLinea,
			String sBanco, String sTarjeta, String sNumTarjeta, String sVenceMes, String sVenceAno, String sCodSeg,
			String sTipoDNI, String sDNITarjeta, String sTitular, String sPromo, String sCuotas)
			throws AWTException, KeyManagementException, NoSuchAlgorithmException {
		// Check All
		imagen = "TS134319";
		detalles = null;
	...
	public void TS134746_CRM_Movil_Prepago_Vista_360_Producto_Activo_del_cliente_Desplegable_FAN_Front_OOCC(String sDNI,
			String sNombre, String sLinea) {
		imagen = "TS134746";
		...
		// Verify info
		Assert.assertTrue(!wFlyoutCard.findElement(By.xpath(
				"//div[@class='items-card ng-not-empty ng-valid'] //div[contains(text(),'Mensajes')] /following-sibling::label"))
				.getText().equalsIgnoreCase("Informaci�n no disponible"));
		Assert.assertTrue(!wFlyoutCard.findElement(By.xpath(
				"//div[@class='items-card ng-not-empty ng-valid'] //div[contains(text(),'MB')] /following-sibling::label"))
				.getText().equalsIgnoreCase("Informaci�n no disponible"));
		Assert.assertTrue(!wFlyoutCard.findElement(By.xpath(
				"//div[@class='items-card ng-not-empty ng-valid'] //div[contains(text(),'KB')] /following-sibling::label"))
				.getText().equalsIgnoreCase("Informaci�n no disponible"));
		Assert.assertTrue(!wFlyoutCard.findElement(By.xpath(
				"//div[@class='items-card ng-not-empty ng-valid'] //div[contains(text(),'Minutos')] /following-sibling::label"))
				.getText().equalsIgnoreCase("Informaci�n no disponible"));
		Assert.assertTrue(!wFlyoutCard.findElement(By.xpath(
				"//div[@class='items-card ng-not-empty ng-valid'] //div[contains(text(),'Segundos')] /following-sibling::label"))
				.getText().equalsIgnoreCase("Informaci�n no disponible"));
		// Verify buttons
		WebElement wRightSideCard = driver.findElement(By.xpath("//*[@class='items-card ng-not-empty ng-valid']"));
		wWebList = wRightSideCard
				.findElements(By.xpath("//button[@class='slds-button slds-button--neutral slds-truncate']"));
		sTextList.clear();
	...
	@Test(groups = { "GestionesPerfilOficina", "HistorialDeRecargas", "Ciclo2" }, dataProvider = "RecargasHistorias")
	public void TS134838_CRM_Movil_Prepago_Historial_de_Recargas_Consultar_detalle_de_Recargas_por_Canal_IVR_Fan_FRONT_OOCC(
			String sDNI) {
		imagen = "TS134838";
	...
	@Test(groups = { "ProblemasConRecargas", "GestionesPerfilTelefonico", "E2E",
			"Ciclo3" }, dataProvider = "CuentaProblemaRecarga")
	public void TS125372_CRM_Movil_Repro_Problemas_con_Recarga_Presencial_TC(String sDNI, String sLinea) {
		...
		sleep(7000);
		driver.switchTo()
				.frame(cambioFrame(driver, By.cssSelector(".slds-icon.slds-icon--large.ta-care-omniscript-done-icon")));
		for (WebElement x : driver.findElements(By.className("ta-care-omniscript-done"))) {
	...
	public void TS136535_CRM_Movil_REPRO_Ajuste_General_FAN_Front_OOCC(String sDNI, String sLinea) {
		...
		sleep(7000);
		driver.switchTo().frame(
				cambioFrame(driver, By.cssSelector(".slds-icon.slds-icon--large.ta-care-omniscript-pending-icon")));
		for (WebElement x : driver.findElements(By.className("ta-care-omniscript-done"))) {
	...
	@Test(groups = { "Suspension", "GestionesPerfilOficina", "E2E", "Ciclo3" }, dataProvider = "CuentaSuspension")
	public void TS98434_CRM_Movil_REPRO_Suspension_por_Siniestro_Robo_Linea_Titular_Presencial(String sDNI,
			String sLinea, String sProvincia, String sCiudad, String sPartido) {
		imagen = "TS98434";
		boolean gestion = false;
		driver.switchTo().frame(cambioFrame(driver, By.id("SearchClientDocumentType")));
		sb.BuscarCuenta("DNI", sDNI);
	...
	@Test(groups = { "Suspension", "GestionesPerfilOficina", "E2E", "Ciclo3" }, dataProvider = "CuentaSuspension")
	public void TS98436_CRM_Movil_REPRO_Suspension_por_Siniestro_Robo_Linea_No_Titular_Presencial(String sDNI,
			String sLinea, String sProvincia, String sCiudad, String sPartido) {
		imagen = "TS98436";
		boolean gestion = false;
		driver.switchTo().frame(cambioFrame(driver, By.id("SearchClientDocumentType")));
	...
	@Test(groups = { "GestionesPerfilOficina", "DiagnosticoInconvenientes" }, dataProvider = "Diagnostico")
	public void TS119210_CRM_Movil_PRE_Diagnostico_de_Voz_Valida_Red_y_Navegacion_Motivo_de_contacto_No_puedo_realizar_ni_recibir_llamadas(
			String sDNI, String sLinea) throws Exception {
		imagen = "TS119210";
		detalles = null;
		...
		WebElement gesti = driver.findElement(By.id("CoverageOkNetMessage")).findElement(By.tagName("div"))
				.findElement(By.tagName("p")).findElements(By.tagName("p")).get(1).findElement(By.tagName("span"))
	...
	@Test(groups = { "GestionesPerfilOficina", "DiagnosticoInconvenientes" }, dataProvider = "Diagnostico")
	public void TS119201_CRM_Movil_PRE_Diagnostico_de_Voz_Valida_Red_y_Navegacion_Motivo_de_contacto_No_puedo_recibir_llamadas_Sin_Locacion_Envia_configuraciones(
			String sDNI, String sLinea) throws Exception {
		imagen = "TS119201";
		detalles = null;
		detalles = imagen + " -Diagnostico - DNI: " + sDNI;
		...
		((JavascriptExecutor) driver).executeScript("window.scrollTo(0,"
				+ driver.findElement(By.cssSelector(".slds-form-element__label.ng-binding.ng-scope")).getLocation().y
				+ " )");
	...
	@Test(groups = { "GestionesPerfilOficina", "DiagnosticoInconvenientes" }, dataProvider = "Diagnostico")
	public void TS119186_CRM_Movil_PRE_Diagnostico_de_Voz_Valida_Red_y_Navegacion_Motivo_de_contacto_No_puedo_realizar_llamadas_Sin_Locacion_NO_recupera_locacion_Geo_rojo(
			String sDNI, String sLinea) throws Exception {
		imagen = "TS119186";
		detalles = null;
		detalles = imagen + " -Diagnostico - DNI: " + sDNI;
		...
		sleep(8000);
		buscarYClick(driver.findElements(By.id("AddressSection_nextBtn")), "equals", "continuar");
		String caso = driver.findElement(By.xpath("//*[@id='MassiveIncidentMessage']/div/p/p[2]/span/strong"))
				.getText();
		System.out.println(caso);
		driver.switchTo().defaultContent();
		tech.buscarCaso(caso);
	...
	@Test(groups = { "GestionesPerfilOficina", "HistorialDeRecargas", "Ciclo2" }, dataProvider = "HistoriaRecarga")
	public void TS134841_CRM_Movil_Prepago_Historial_de_Recargas_Consultar_detalle_de_Recargas_por_Canal_SMS_Fan_FRONT_OOCC(
			String sDNI, String sLinea) {
		imagen = "TS134847";
		detalles = imagen + "-Historial De Recarga-DNI:" + sDNI;
		driver.switchTo().frame(cambioFrame(driver, By.id("SearchClientDocumentType")));
		...
		sleep(7000);
		driver.findElement(By.id("text-input-03")).click();
		List<WebElement> sms = driver.findElement(By.cssSelector(".slds-dropdown__list.slds-dropdown--length-5"))
				.findElements(By.tagName("li"));
	...
	@Test(groups = { "GestionesPerfilOficina", "HistorialDeRecargas", "Ciclo2" }, dataProvider = "HistoriaRecarga")
	public void TS134842_CRM_Movil_Prepago_Historial_de_Recargas_Consultar_detalle_de_Recargas_por_Canal_ROL_Fan_FRONT_OOCC(
			String sDNI, String sLinea) {
		imagen = "TS134842";
		detalles = imagen + "-Historial De Recarga-DNI:" + sDNI;
		driver.switchTo().frame(cambioFrame(driver, By.id("SearchClientDocumentType")));
		...
		sleep(7000);
		driver.findElement(By.id("text-input-03")).click();
		List<WebElement> recarga = driver.findElement(By.cssSelector(".slds-dropdown__list.slds-dropdown--length-5"))
				.findElements(By.tagName("li"));
	...
	@Test(groups = { "GestionesPerfilOficina", "HistorialDeRecargas", "Ciclo2" }, dataProvider = "RecargasHistorias")
	public void TS135472_CRM_Movil_Prepago_Historial_de_Packs_Nombre_del_Pack_Plan_Internacional_FAN_Front_OOCC(
			String sDNI) {
		imagen = "TS135472";
		detalles = imagen + "-Historial De Packs -DNI:" + sDNI;
		driver.switchTo().frame(cambioFrame(driver, By.id("SearchClientDocumentType")));
		...
		sleep(5000);
		driver.findElement(By.id("text-input-03")).click();
		// Falta la opcion en el Nombre del pack: Plan Internacional --- Se requiere
		// actualizar cuando exista el Pack Internacional
		List<WebElement> todos = driver.findElement(By.cssSelector(".slds-dropdown__list.slds-dropdown--length-5"))
				.findElements(By.tagName("li"));
		for (WebElement t : todos) {
	...
	public void TS135474_CRM_Movil_Prepago_Historial_de_Packs_Nombre_del_Pack_Plan_Familia_FAN_Front_OOCC(String sDNI) {
		...
		sleep(5000);
		driver.findElement(By.id("text-input-03")).click();
		// Falta la opcion en el Nombre del pack: Plan Familia --- Se requiere
		// actualizar cuando exista el Pack Familia
		List<WebElement> todos = driver.findElement(By.cssSelector(".slds-dropdown__list.slds-dropdown--length-5"))
				.findElements(By.tagName("li"));
		for (WebElement t : todos) {
	...
	@Test(groups = { "GestionesPerfilOficina", "DiagnosticoInconvenientes" }, dataProvider = "Diagnostico")
	public void TS105466_CRM_CRM_Movil_Repro_Autogestion_WEB_Incon_con_Compra_de_packs_No_Resuelto(String sDNI,
			String sLinea) throws InterruptedException {
		imagen = "TS105466";
		detalles = null;
		detalles = imagen + "- Autogestion - DNI: " + sDNI;
	...
	public void TS136536_CRM_Movil_REPRO_Escalamiento_segun_RAV_FAN_Front_OOCC(String sDNI, String sLinea) {
		...
		selectByText(driver.findElement(By.cssSelector(".topNav.primaryPalette")).findElement(By.name("fcf")),
				"BO Centralizado");
	...
	@Test(groups = { "GestionesPerfilOficina", "DiagnosticoInconvenientes", "E2E",
			"Ciclo3" }, dataProvider = "Diagnostico")
	public void TS_119162_CRM_Movil_PRE_Diagnostico_de_Voz_Valida_Red_y_Navegacion_Motivo_de_contacto_No_puedo_realizar_llamadas(
			String sDNI, String sLinea) {
		boolean caso = false;
		imagen = "TS119262";
		detalles = null;
	...
	@Test(groups = { "GestionesPerfilOficina", "DiagnosticoInconvenientes", }, dataProvider = "Diagnostico")
	public void TS105449_CRM_Movil_Repro_Autogestion_0800_Informa_Sistema_Fuera_de_Servicio_No_Resuelto(String sDNI,
			String sLinea) throws InterruptedException {
		imagen = "TS105449";
		detalles = null;
		detalles = imagen + "- Autogestion - DNI: " + sDNI;
	...
	@Test(groups = { "GestionesPerfilOficina", "Resumen de Cuenta Corriente", "E2E",
			"Ciclo4" }, dataProvider = "CuentaReintegros")
	public void TS129461_CRM_Movil_REPRO_Resumen_de_Cuenta_Corriente_Verificacion_de_vista_de_Resumen_de_Cuenta_Corriente_FAN_Front_OOCC(
			String sDNI) {
		imagen = "TS129461";
		detalles = null;
		detalles = imagen + " -Resumen de Cuenta Corriente - DNI: " + sDNI;
		...
		boton.click();
		sleep(5000);
		WebElement comprobante = driver.findElement(
				By.cssSelector(".slds-grid.slds-wrap.slds-card.slds-m-bottom--small.slds-p-around--medium"));
		Assert.assertTrue(comprobante.getText().toLowerCase().contains("comprobantes"));
	}

	@Test(groups = { "GestionesPerfilOficina", "Nominacion",
			"Ciclo1" }, dataProvider = "DatosNominacionExistente5Lineas")
	public void TS85104_CRM_Movil_REPRO_No_Nominatividad_Numero_Limite_De_Lineas_Cliente_Existente_Presencial(
			String sLinea, String sDni) {
		imagen = "TS85104";
		detalles = null;
		detalles = imagen + " -Nominacion: " + sDni + "- Linea: " + sLinea;
		boolean nominacion = false;
	...
	@Test(groups = { "GestionesPerfilOficina", "Nominacion",
			"Ciclo1" }, dataProvider = "DatosNoNominacionExistenteFraudeOfcom")
	public void TS85105_CRM_Movil_REPRO_No_Nominatividad_Por_Fraude_Cliente_Existente_Presencial(String sLinea,
			String sDni) {
		imagen = "TS85105";
		detalles = null;
		detalles = imagen + " -Nominacion: " + sDni + "- Linea: " + sLinea;
		...
		ContactSearch contact = new ContactSearch(driver);
		contact.searchContact2("DNI", sDni, "Masculino");
		Assert.assertTrue(driver.findElement(By.cssSelector(".message.description.ng-binding.ng-scope")).getText()
				.toLowerCase().contains("el dni figura en lista de fraude"));

	}

	@Test(groups = { "GestionesPerfilOficina", "DiagnosticoInconvenientes", }, dataProvider = "Diagnostico")
	public void TS105453_CRM_Movil_Repro_Autogestion_0800_La_Linea_esta_muda_No_Resuelto(String cDNI, String cLinea)
			throws InterruptedException {
		imagen = "TS105453";
		detalles = null;
		detalles = imagen + "- Autogestion - DNI: " + cDNI;
	...
	@Test(groups = { "GestionesPerfilOficina", "ProblemaRecarga", "E2E",
			"Ciclo3" }, dataProvider = "CuentaProblemaRecarga")
	public void TS104350_CRM_Movil_REPRO_Problemas_con_Recarga_Presencial_Tarjeta_Scratch_Caso_Nuevo_Inactiva(
			String sDNI, String sLinea) {
		imagen = "TS104350";
		boolean gestion = false, error = false;
		String datoViejo = cbs.ObtenerValorResponse(cbsm.Servicio_queryLiteBySubscriber(sLinea), "bcs:MainBalance");
		...
		driver.findElement(By.id("PrepaidCardData_nextBtn")).click();
		sleep(5000);
		WebElement msj = driver.findElement(By
				.xpath("//*[@class='vlc-slds-inline-control__label' and contains(text(), 'Estado de la tarjeta: ')]"));
		System.out.println(msj.getText());
		Assert.assertTrue(msj.findElement(By.xpath("//*[@id='PrepaidCardStatusLabel']//label/strong")).getText()
				.equalsIgnoreCase("Activa"));
	}

	@Test(groups = { "GestionesPerfilOficina", "ResumenDeCuenta", "Ciclo4" }, dataProvider = "CuentaVista360")
	public void TS124406_CRM_Movil_REPRO_Resumen_de_Cuenta_Corriente_Visualizacion_del_Resumen_de_Cuenta_Corriente_a_nivel_de_cuenta_de_Facturacion_FAN_Front_OOCC(
			String sDNI, String sLinea, String sNombre, String sCuenta, String sMovil) {
		imagen = "TS124406";
		String cuenta = null;
		driver.switchTo().frame(cambioFrame(driver, By.id("SearchClientDocumentType")));
		sb.BuscarCuenta("DNI", sDNI);
		...
		WebElement sald = driver.findElement(By.cssSelector(".slds-text-heading--medium.secondaryFont"))
				.findElement(By.tagName("b"));
		sald.isDisplayed();
		saldo = true;
		WebElement comprobante = driver.findElement(By.cssSelector(
				".slds-size--1-of-1.slds-medium-size--1-of-1.slds-large-size--1-of-1.slds-m-top--x-large"));
	...
	@Test(groups = { "GestionesPerfilOficina", "ResumenDeCuenta", "Ciclo4" }, dataProvider = "CuentaVista360")
	public void TS124411_CRM_MovilREPRO_Resumen_de_Cuenta_Corriente_Visualizacion_del_Resumen_de_Cuenta_Corriente_a_nivel_de_cuenta_de_Facturacion_Detalle_ampliado_FAN_Front_OOCC(
			String sDNI, String sLinea, String sNombre, String sCuenta, String sMovil) {
		imagen = "TS124411";
		String cuenta = null;
		driver.switchTo().frame(cambioFrame(driver, By.id("SearchClientDocumentType")));
		...
		System.out.println("El Resumen de Cuenta Corresponde a la cuenta: " + cuenta);
		Assert.assertTrue(cuenta.equalsIgnoreCase(sCuenta));
		WebElement detaFactu = driver
				.findElement(By.xpath("//*[@class='slds-p-bottom--small']/table/tbody/tr/td/div/a/i"));
		detaFactu.click();
		sleep(5000);
		driver.switchTo().frame(
				cambioFrame(driver, By.cssSelector(".slds-wrap.slds-card.slds-m-bottom--small.slds-p-around--medium")));
		Assert.assertTrue(
				driver.findElements(By.cssSelector(".slds-wrap.slds-card.slds-m-bottom--small.slds-p-around--medium"))
						.get(0).isDisplayed());

	}

	@Test(groups = { "GestionesPerfilOficina", "ResumenDeCuenta", "Ciclo4" }, dataProvider = "CuentaVista360")
	public void TS124414_CRM_Movil_REPRO_Resumen_de_Cuenta_Corriente_Visualizacion_del_Resumen_de_Cuenta_Corriente_a_nivel_de_cuenta_de_Facturacion_Descarga_FAN_Front_OOCC(
			String sDNI, String sLinea, String sNombre, String sCuenta, String sMovil) {
		imagen = "TS124414";
		String cuenta = null;
		driver.switchTo().frame(cambioFrame(driver, By.id("SearchClientDocumentType")));
		...
		WebElement descargar = driver.findElement(By.className("slds-float--right"))
				.findElement(By.className("boton2"));
	...
	@Test(groups = { "GestionesPerfilOficina", "ResumenDeCuenta", "Ciclo4" }, dataProvider = "CuentaVista360")
	public void TS124415_CRM_Movil_REPRO_Resumen_de_Cuenta_Corriente_Visualizacion_del_Resumen_de_Cuenta_Corriente_a_nivel_de_cuenta_de_Facturacion_Impresion_FAN_Front_OOCC(
			String sDNI, String sLinea, String sNombre, String sCuenta, String sMovil) {
		imagen = "TS124415";
		String cuenta = null;
		driver.switchTo().frame(cambioFrame(driver, By.id("SearchClientDocumentType")));
	...
	@Test(groups = { "GestionesPerfilOficina", "ResumenDeCuenta", "Ciclo4" }, dataProvider = "CuentaVista360")
	public void TS129473_CRM_Movil_REPRO_Resumen_de_Cuenta_Corriente_Detalle_ampliado_registro_de_Pago_FAN_Front_OOCC(
			String sDNI, String sLinea, String sNombre, String sCuenta, String sMovil) {
		imagen = "TS129473";
		String cuenta = null;
		driver.switchTo().frame(cambioFrame(driver, By.id("SearchClientDocumentType")));
		...
		((JavascriptExecutor) driver).executeScript("window.scrollTo(0," + driver
				...
				.get(1).getLocation().y + " )");
		sleep(5000);
		WebElement detapagos = driver.findElement(By.xpath(
				"//*[@class='slds-text-heading--large slds-size--1-of-1 slds-medium-size--1-of-1 slds-large-size--1-of-1 slds-m-bottom--small'] //b[contains(text(), 'Pagos')] /.. /.. /.. //*[@class='slds-p-bottom--small'] //tr[3] //td[5] //a"));
		detapagos.click();
		sleep(15000);
	...
	@Test(groups = { "GestionesPerfilOficina", "ResumenDeCuenta", "Ciclo4" }, dataProvider = "CuentaVista360")
	public void TS129475_CRM_Movil_REPRO_Resumen_de_Cuenta_Corriente_Detalle_ampliado_registro_de_Comprobante_Nota_de_Credito_Debito_FAN_Front_OOCC(
			String sDNI, String sLinea, String sNombre, String sCuenta, String sMovil) {
		imagen = "TS129475";
		String cuenta = null;
		driver.switchTo().frame(cambioFrame(driver, By.id("SearchClientDocumentType")));
		...
		Assert.assertTrue(cuenta.equalsIgnoreCase(sCuenta));
		WebElement detaFactu = driver
				.findElement(By.xpath("//*[contains(text(),'NCBR')]/../following-sibling::*//div/a"));
		detaFactu.click();
		sleep(5000);
	...
	public void TS119275_CRM_Movil_PRE_Diagnostico_de_Datos_Valida_Red_y_Navegacion_Motivo_de_contacto_No_puedo_Navegar_ANTENA_ROJO_Evento_Masivo_NO_BAM(
			String sDNI, String sLinea) throws InterruptedException {
		imagen = "TS119275";
		detalles = null;
		detalles = imagen + " -Diagnostico - DNI: " + sDNI;
		CustomerCare cCC = new CustomerCare(driver);
		...
		sleep(8000);
		buscarYClick(driver.findElements(By.id("AddressSection_nextBtn")), "equals", "continuar");
		String caso_1 = driver.findElement(By.xpath("//*[@id=\"MassiveIncidentMessage\"]/div/p/p[2]/span/strong"))
				.getText();
	...
	@Test(groups = { "GestionesPerfilOficina", "Diagnostico/Inconvenientes" }, dataProvider = "Diagnostico")
	public void TS119279_CRM_Movil_PRE_Diagnostico_de_Datos_Valida_Red_y_Navegacion_Motivo_de_contacto_No_puedo_Navegar_CONCILIAR_NO_BAM(
			String sDNI, String sLinea) throws InterruptedException {
		imagen = "TS119279";
		detalles = null;
		detalles = imagen + " -Diagnostico - DNI: " + sDNI;
		...
		buscarYClick(driver.findElements(By.id("NetworkCategory_nextBtn")), "equals", "continuar");
		sleep(30000);
		String caso_1 = driver.findElement(By.xpath("//*[@id=\"IncorrectCategoriesMessage\"]/div/p/p[2]/span/strong"))
				.getText();
		System.out.println(caso_1);
		driver.switchTo().defaultContent();
		tech.buscarCaso(caso_1);
	...
	@Test(groups = { "GestionesPerfilOficina", "Diagnostico/Inconvenientes" }, dataProvider = "Diagnostico")
	public void TS119283_CRM_Movil_REPRO_Diagnostico_de_Datos_Valida_Red_y_Navegacion_Motivo_de_contacto_No_puedo_navegar_Antena_rojo_NO_BAM(
			String sDNI, String sLinea) throws InterruptedException {
		imagen = "TS119283";
		detalles = null;
		detalles = imagen + " -Diagnostico - DNI: " + sDNI;
	...
	@Test(groups = { "GestionesPerfilOficina", "Diagnostico/Inconvenientes" }, dataProvider = "Diagnostico")
	public void TS119267_CRM_Movil_PRE_Diagnostico_de_Datos_Valida_Red_y_Navegacion_Motivo_de_contacto_No_puedo_Navegar_Sin_conciliar_ni_desregistrar_Envio_de_configuracion(
			String sDNI, String sLinea) throws InterruptedException {
		imagen = "TS119267";
		detalles = null;
		detalles = imagen + " -Diagnostico - DNI: " + sDNI;
		...
		// buscarYClick(driver.findElements(By.className("borderOverlay")), "contains",
		// "enviar");
		...
		sleep(8000);
		String caso_1 = driver.findElement(By.xpath("//*[@id=\"ConfigurationCaseMessage\"]/div/p/p/span/strong"))
				.getText();
		System.out.println(caso_1);
		driver.switchTo().defaultContent();
		tech.buscarCaso(caso_1);
	...
	@Test(groups = { "GestionesPerfilOficina", "Diagnostico/Inconvenientes" }, dataProvider = "Diagnostico")
	public void TS119286_CRM_Movil_PRE_Diagnostico_de_Datos_Valida_Red_y_Navegacion_Motivo_de_contacto_Navega_con_lentitud_Fuera_del_area_de_cobertura_NO_BAM(
			String sDNI, String sLinea) throws InterruptedException {
		imagen = "TS119286";
		detalles = null;
		detalles = imagen + " -Diagnostico - DNI: " + sDNI;
		...
		Tech.categoriaRed("Fuera del Area de Cobertura");
		sleep(8000);
		String caso_1 = driver.findElement(By.xpath("//*[@id=\"OutOfCoverageMessage\"]/div/p/p[2]/span/strong"))
				.getText();
		System.out.println(caso_1);
		driver.switchTo().defaultContent();
		tech.buscarCaso(caso_1);
	...
	@Test(groups = { "GestionesPerfilOficina", "DiagnosticoInconvenientes" }, dataProvider = "Diagnostico")
	public void TS119183_CRM_Movil_PRE_Diagnostico_de_Voz_Valida_Red_y_Navegacion_Motivo_de_contacto_No_puedo_realizar_llamadas_Sin_Locacion_Servicio_con_suspencion(
			String sDNI, String sLinea) throws Exception {
		imagen = "TS119183";
		detalles = null;
		detalles = imagen + " -Diagnostico - DNI: " + sDNI;
	...
	@Test(groups = { "GestionesPerfilOficina", "DiagnosticoInconvenientes" }, dataProvider = "Diagnostico")
	public void TS119178_CRM_Movil_PRE_Diagnostico_de_Voz_Valida_Red_y_Navegacion_Motivo_de_contacto_No_puedo_realizar_llamadas_Sin_Locacion_Evento_Masivo(
			String sDNI, String sLinea) throws Exception {
		imagen = "TS119178";
		detalles = null;
		detalles = imagen + " -Diagnostico - DNI: " + sDNI;
	...
	@Test(groups = { "GestionesPerfilOficina", "Diagnostico/Inconvenientes" }, dataProvider = "Diagnostico")
	public void TS119266_CRM_Movil_PRE_Diagnostico_de_Datos_Valida_Red_y_Navegacion_Motivo_de_contacto_No_puedo_Navegar_sin_rellamado_NO_BAM(
			String sDNI, String sLinea) throws InterruptedException {
		imagen = "TS119266";
		detalles = null;
		detalles = imagen + " -Diagnostico - DNI: " + sDNI;
		...
		buscarYClick(driver.findElements(By.id("MotiveIncidentSelect_nextBtn")), "equals", "continuar");
		sleep(8000);
		String cuota = driver.findElement(By.xpath("//*[@id=\"AvailableDataQuotaDisplay\"]/div/p/div/p[2]/span"))
				.getText();
		String saldo = driver.findElement(By.xpath("//*[@id=\"AvailableDataBalanceDisplay\"]/div/p/div/p[2]/span"))
				.getText();
		...
		driver.findElement(By.id("MobileConfigurationSending_nextBtn")).click();
		sleep(8000);
		String caso_1 = driver.findElement(By.xpath("//*[@id=\"MobileConfigSendingMessage\"]/div/p/h1/span/strong"))
				.getText();
		System.out.println(caso_1);
		driver.switchTo().defaultContent();
		tech.buscarCaso(caso_1);
	...
	@Test(groups = { "GestionesPerfilOficina", "Diagnostico/Inconvenientes" }, dataProvider = "Diagnostico")
	public void TS119221_CRM_Movil_PRE_Diagnostico_de_Voz_Valida_Red_y_Navegacion_Motivo_de_contacto_No_puedo_realizar_ni_recibir_llamadas_Sin_Locacion_Evento_Masivo(
			String sDNI, String sLinea) throws InterruptedException {
		imagen = "TS119221";
		detalles = null;
		detalles = imagen + " -Diagnostico - DNI: " + sDNI;
		...
		// selectByText(driver.findElement(By.id("Motive")), "No puedo realizar ni
		// recibir llamadas");
		buscarYClick(driver.findElements(By.id("MotiveIncidentSelect_nextBtn")), "equals", "continuar");
		sleep(3000);
		driver.switchTo().frame(cambioFrame(driver, By.id("BalanceValidation_nextBtn")));
		String saldo = driver.findElement(By.xpath("//*[@id=\"AvailableVoiceBalanceDisplay\"]/div/p/div/p[2]/span"))
				.getText();
